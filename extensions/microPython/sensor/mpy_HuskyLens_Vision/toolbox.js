...
<category name="%{BKY_HUSKYLENSVISION_CATEGORY}" id="HUSKYLENSVISION_CATEGORY" colour="#00a300" secondaryColour="#008000" iconURI="${HUSKYLENS_VISION_ICON}">
    <block type="huskylens_use_i2c_init">
        <value name="SUB">
  ...
  <block type="huskylens_request_algorthim">
        <value name="SUB">
            <shadow type="variables_get">
                <field name="VAR">husky</field>
            </shadow>
    ...
    <block type="huskylens_command_request">
        <value name="SUB">
            <shadow type="variables_get">
                <field name="VAR">husky</field>
            </shadow>
    ...
    <block type="huskylens_command_request_forget">
        <value name="SUB">
            <shadow type="variables_get">
                <field name="VAR">husky</field>
            </shadow>
    ...
    <block type="huskylens_command_request_clear_text">
        <value name="SUB">
            <shadow type="variables_get">
                <field name="VAR">husky</field>
            </shadow>
    ...
    <block type="huskylens_command_request_photo_screenshot">
        <value name="SUB">
            <shadow type="variables_get">
                <field name="VAR">husky</field>
            </shadow>
