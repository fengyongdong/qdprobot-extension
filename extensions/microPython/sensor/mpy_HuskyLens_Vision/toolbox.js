...
<category name="%{BKY_HUSKYLENSVISION_CATEGORY}" id="HUSKYLENSVISION_CATEGORY" colour="#00a300" secondaryColour="#008000" iconURI="${HUSKYLENS_VISION_ICON}">
    <block type="huskylens_use_i2c_init"></block>
    <block type="huskylens_request_algorthim"></block>
    <block type="huskylens_command_request"></block>
    <block type="huskylens_read_learned_id_count">
        <value name="SUB">
            <shadow type="variables_get">
                <field name="VAR">husky</field>
            </shadow>
        </value>
    </block>
    <block type="huskylens_is_appear_direct">
        <value name="SUB">
            <shadow type="variables_get">
                <field name="VAR">husky</field>
            </shadow>
    ...
    <block type="huskylens_read_block_center_parameter_direct">
        <value name="SUB">
            <shadow type="variables_get">
                <field name="VAR">husky</field>
            </shadow>
    ...
    <block type="huskylens_read_arrow_center_parameter_direct">
        <value name="SUB">
            <shadow type="variables_get">
                <field name="VAR">husky</field>
            </shadow>
    ...
    <block type="huskylens_is_learned_id">
        <value name="SUB">
            <shadow type="variables_get">
                <field name="VAR">husky</field>
            </shadow>
    ...
    <block type="huskylens_is_appear_id">
        <value name="SUB">
            <shadow type="variables_get">
                <field name="VAR">husky</field>
            </shadow>
    ...
    <block type="huskylens_read_block_id_parameter_direct">
        <value name="ID">
            <shadow type="math_number">
                <field name="NUM">1</field>
            </shadow>
    ...
    <block type="huskylens_read_arrow_id_parameter_direct">
        <value name="ID">
            <shadow type="math_number">
                <field name="NUM">1</field>
            </shadow>
    ...
    <block type="huskylens_read_count">
        <value name="ID">
            <shadow type="math_number">
                <field name="NUM">1</field>
            </shadow>
    ...
    <block type="huskylens_read_blocks_parameter_direct">
        <value name="NUM">
            <shadow type="math_number">
                <field name="NUM">0</field>
            </shadow>
    ...
    <block type="huskylens_read_arrows_parameter_direct">
        <value name="NUM">
            <shadow type="math_number">
                <field name="NUM">0</field>
            </shadow>
    ...
    <block type="huskylens_command_request_learn_once">
        <value name="ID">
            <shadow type="math_number">
                <field name="NUM">1</field>
            </shadow>
    ...
    <block type="huskylens_command_request_forget"></block>
    <block type="huskylens_command_request_customnames">
        <value name="ID">
            <shadow type="math_number">
                <field name="NUM">1</field>
            </shadow>
    ...
    <block type="huskylens_command_request_custom_text">
        <value name="x">
            <shadow type="math_number">
                <field name="NUM">0</field>
            </shadow>
    ...
    <block type="huskylens_command_request_clear_text"></block>
    <block type="huskylens_command_request_photo_screenshot"></block>
    <block type="huskylens_save_load_model_to_SD_card">
        <value name="num">
            <shadow type="haskylens_model">
          </shadow>
        </value>
    </block>
</category>`;
