...
function addBlocks (Blockly) {
    ...
    Blockly.Blocks.huskylens_use_i2c_init= {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_use_i2c_init,
                args0: [
                    {
                        type: 'field_image',
    ...
    Blockly.Blocks.huskylens_request_algorthim= {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_request_algorthim,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
                ...
                args1: [
                    ...
                    },
                    {
                        type: 'field_dropdown',
                        name: 'CTYPE',
                        options: [[Blockly.Msg.MICROPYTHON_HUSKYLENS_ALGORITHM_OBJECT_TRACKING, "ALGORITHM_OBJECT_TRACKING"],
            [Blockly.Msg.AipFace, "ALGORITHM_FACE_RECOGNITION"],
            [Blockly.Msg.MICROPYTHON_HUSKYLENS_ALGORITHM_OBJECT_RECOGNITION, "ALGORITHM_OBJECT_RECOGNITION"],
            [Blockly.Msg.MICROPYTHON_HUSKYLENS_ALGORITHM_LINE_TRACKING, "ALGORITHM_LINE_TRACKING"],
            [Blockly.Msg.catImage_Color, "ALGORITHM_COLOR_RECOGNITION"],
            [Blockly.Msg.MICROPYTHON_HUSKYLENS_ALGORITHM_TAG_RECOGNITION, "ALGORITHM_TAG_RECOGNITION"],
            [Blockly.Msg.MICROPYTHON_HUSKYLENS_ALGORITHM_OBJECT_CLASSIFICATION, "ALGORITHM_OBJECT_CLASSIFICATION"],
            [Blockly.Msg.MICROPYTHON_HUSKYLENS_ALGORITHM_QR_CODE_RECOGNTITION, "ALGORITHM_QR_CODE_RECOGNTITION"],
            [Blockly.Msg.MICROPYTHON_HUSKYLENS_ALGORITHM_BARCODE_RECOGNTITION, "ALGORITHM_BARCODE_RECOGNTITION"]
            ]
                    }
                ],
    ...
    Blockly.Blocks.huskylens_command_request = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_command_request,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_read_learned_id_count = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_read_learned_id_count,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_is_appear_direct = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_is_appear_direct,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
                ...
                args1: [
                    ...
                    },
                    {
                        ...
                        name: 'CTYPE',
                        options: [
                            [Blockly.Msg.RESULT_BLOCK, 'blocks'],
                            [Blockly.Msg.RESULT_ARROW, 'arrows']
                        ]
                    }
                ],
    ...
    Blockly.Blocks.huskylens_read_block_center_parameter_direct = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_read_block_center_parameter_direct,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_read_arrow_center_parameter_direct = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_read_arrow_center_parameter_direct,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
                ...
                "tooltip": "从请求得到的“结果”中获取当前界面中靠近中心的箭头信息，未学习的方框id为0，没有则返回-1",
                colour: color,
                secondaryColour: secondaryColor,
                extensions: ['output_number']
            });
    ...
    Blockly.Blocks.huskylens_is_learned_id = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_is_learned_id,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_is_appear_id = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_is_appear_id,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_read_block_id_parameter_direct = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_read_block_id_parameter_direct,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_read_arrow_id_parameter_direct = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_read_arrow_id_parameter_direct,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_read_count = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_read_count,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_read_blocks_parameter_direct = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_read_blocks_parameter_direct,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_read_arrows_parameter_direct = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_read_arrows_parameter_direct,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_command_request_learn_once = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_command_request_learn_once,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_command_request_forget = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_command_request_forget,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_command_request_customnames = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_command_request_customnames,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_command_request_custom_text = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_command_request_custom_text,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_command_request_clear_text = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_command_request_clear_text,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
    ...
    Blockly.Blocks.huskylens_command_request_photo_screenshot = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_command_request_photo_screenshot,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
                ...
                args1: [
                    ...
                    },
                    {
                        ...
                        name: 'CTYPE',
                        options: [
                            [Blockly.Msg.PHOTO_TAKE_PHOTO, 'photo'],
    ...
    Blockly.Blocks.huskylens_save_load_model_to_SD_card = {
        init: function () {
            this.jsonInit ({
                message0: '%1',
                message1: Blockly.Msg.huskylens_save_load_model_to_SD_card,
                args0: [
                    {
                        type: 'field_image',
                        src: huskyLens_vision_icon,
                ...
                args1: [
                    ...
                    },
                    {
                        ...
                        name: 'CTYPE',
                        options: [
                            [Blockly.Msg.MODEL_SAVE, 'save'],
                            [Blockly.Msg.MODEL_LOAD, 'load']
                        ]
                    },
                    {
                        type: 'input_value',
