...
function addBlocks (Blockly) {
    ...
    var esp32_i2c_sda_pin = [
        ["IO21", "21"],
    ];

    var esp32_i2c_scl_pin = [
        ["IO22", "22"],
    ];

    var huskyLens_vision_address = [
        ["0x32", "0x32"]           
    ];
                ...
                args1: [
                    {
                        type: 'field_dropdown',
                        name: 'SDA_PIN',
                        options: esp32_i2c_sda_pin
                    },
                    {
                        type: 'field_dropdown',
                        name: 'SCL_PIN',
                        options: esp32_i2c_scl_pin
                    },
                    {
                        type: 'field_dropdown',
                        name: 'ADDRESS',
                        options: huskyLens_vision_address
                    }
                ],
