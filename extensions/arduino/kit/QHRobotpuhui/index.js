const QDPRobotpuhui = formatMessage => ({
    name: '普惠AI人工智能系列',                //显示在扩展选择界面的名字
    extensionId: 'QDPRobotpuhui',         //扩展的唯一ID
    ...
    iconURL: `asset/puhui.png`,   //显示在扩展选择界面的图片，图片比例和像素参数请参照DHT11样例中的修改
    description: formatMessage({
        id: 'QDPRobotpuhui.description',
        default: 'QDP robot',
        description: 'QDPRobotpuhui.description'
    }),                           //显示在扩展选择界面图片下方扩展介绍内容
    featured: true,
