...
Blockly.Arduino.qdp_lattice_max7219 = function() {
    Blockly.Arduino.definitions_['include_MD_Parola'] ='#include <MD_Parola.h>';
    Blockly.Arduino.definitions_['include_MD_MAX72xx'] = '#include <MD_MAX72xx.h>';
    Blockly.Arduino.definitions_['include_SPI'] = '#include <SPI.h>';
    Blockly.Arduino.definitions_['var_declare'] = 'MD_Parola P = MD_Parola(14, 13, 12, 4);\nMD_MAX72XX mx = MD_MAX72XX(14, 13, 12, 4);\n';
    Blockly.Arduino.setups_['max7219setup'] = 'mx.begin();\n  P.begin();';
    return 'P.displayAnimate();\n';
};

Blockly.Arduino.qdp_lattice_brightness = function() {
    var brightness= Blockly.Arduino.valueToCode(this, 'brightness', Blockly.Arduino.ORDER_ATOMIC);
    var code='P.setIntensity('+brightness+');\n';
    return code;
};

Blockly.Arduino.qdp_lattice_finished_condition = function() {
    var code = 'P.displayAnimate()';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.qdp_lattice_displayClear = function() {
    var code='P.displayClear();\nmx.clear();\n';
    return code;
};

Blockly.Arduino.qdp_lattice_max7219_display = function() {
    var display= Blockly.Arduino.valueToCode(this, 'display', Blockly.Arduino.ORDER_ATOMIC);
    var code='P.print('+display+');\n';
    return code;
};

Blockly.Arduino.qdp_lattice_max7219_Scroll_display = function() {
    ...
    Blockly.Arduino.definitions_['var_declare_ mylist'+number] = 'char mylist_' +number+ '[80]={};\n';
    var code='if (P.displayAnimate()){\n   String('+str+').toCharArray(mylist_' +number+ ', sizeof(mylist_' +number+ '));\n P.displayScroll(mylist_' +number+ ', PA_LEFT, PA_SCROLL_LEFT, '+speed+');\n}\n';
    return code;
};

Blockly.Arduino.qdp_lattice_centered_display1 = function() {
    var number = Math.ceil(Math.random() * 100000);
    var alignment= this.getFieldValue('alignment');
    var Display_content= Blockly.Arduino.valueToCode(this, 'Display_content', Blockly.Arduino.ORDER_ATOMIC);
    var display_time= Blockly.Arduino.valueToCode(this, 'display_time', Blockly.Arduino.ORDER_ATOMIC);
    var Display_speed= Blockly.Arduino.valueToCode(this, 'Display_speed', Blockly.Arduino.ORDER_ATOMIC);
    var Enter_effect= Blockly.Arduino.valueToCode(this, 'Enter_effect', Blockly.Arduino.ORDER_ATOMIC);
    var Exit_effect= Blockly.Arduino.valueToCode(this, 'Exit_effect', Blockly.Arduino.ORDER_ATOMIC);
    Blockly.Arduino.definitions_['var_declare_ mylist'+number] = 'char mylist_' +number+ '[80]={};\n';
    var code='if (P.displayAnimate()){\n   String('+Display_content+').toCharArray(mylist_' +number+ ', sizeof(mylist_' +number+ '));\n P.displayText(mylist_' +number+ ', '+alignment+', '+Display_speed+', '+display_time+', '+Enter_effect+', '+Exit_effect+');\n}\n';
    return code;
};

Blockly.Arduino.qdp_lattice_effect = function() {
    var effect= this.getFieldValue('effect');
    var code = ''+effect+'';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.QDP_OneButton_interrupt = function () {
 Blockly.Arduino.definitions_['include_OneButton'] = '#include <OneButton.h>';
 var dropdown_pin = 2;
 var dropdown_mode = this.getFieldValue('mode');
 Blockly.Arduino.definitions_['var_declare_button'+dropdown_pin] = 'OneButton button'+dropdown_pin+'(2,true);';
 ...
 var code;
 Blockly.Arduino.loops_['tick'+dropdown_pin] = 'button' +dropdown_pin+ '.tick();\n';
...
Blockly.Arduino.qdp_ESP8266_buttonl = function() {
  ...
  //左右按钮
Blockly.Arduino.qdp_ESP8266_buttonx = function() {
  var pin = this.getFieldValue('pin2');
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  Blockly.Arduino.setups_['setup_input_'+pin ]= 'pinMode(P'+pin+'L, INPUT);\n  pinMode(P'+pin+'R, INPUT);';
  var code = 'digitalRead(P'+pin+'L)||digitalRead(P'+pin+'R)';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

//启用多功能按钮
Blockly.Arduino.qdp_ESP8266_buttonfuction1 = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var code = 'button'+dropdown_pin+'.Update();\n';
  return code;
};
//多功能钮
Blockly.Arduino.qdp_ESP8266_button1 = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_pin2 = this.getFieldValue('PIN2');
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  Blockly.Arduino.definitions_['define_include_clickButton'] = '#include <clickButton.h>';
  if(dropdown_pin=='PBL'||dropdown_pin=='PBR'||dropdown_pin=='ButtonPin')
    Blockly.Arduino.definitions_['define_click0'+dropdown_pin] = 'ClickButton button'+dropdown_pin+'('+dropdown_pin+',LOW);\n';
  else
    Blockly.Arduino.definitions_['define_click0'+dropdown_pin] = 'ClickButton button'+dropdown_pin+'('+dropdown_pin+',HIGH);\n';
  var code = 'button'+dropdown_pin+'.buttoncheck('+dropdown_pin2+')';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
  };
//超声波
Blockly.Arduino.qdp_ESP8266_chaoshengbo = function() {
  var PIN = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  Blockly.Arduino.setups_['setup_output_L' + PIN] = 'pinMode(P' + PIN + 'L, OUTPUT);';
  Blockly.Arduino.setups_['setup_output_R' + PIN] = 'pinMode(P' + PIN + 'R, INPUT);';
  var funcName = 'checkdistance_' + PIN ;
  var code = 'float' + ' ' + funcName + '() {\n'
  + '  digitalWrite(P' + PIN + 'L, LOW);\n' + '  delayMicroseconds(2);\n'
  + '  digitalWrite(P' + PIN + 'L, HIGH);\n' + '  delayMicroseconds(10);\n'
  + '  digitalWrite(P' + PIN + 'L, LOW);\n'
  + '  float distance = pulseIn(P' + PIN + 'R, HIGH) / 58.00;\n'
  + '  delay(10);\n' + '  return distance;\n'
  + '}\n';
...
//超声波I2C
Blockly.Arduino.qdp_ESP8266_chaoshengboI2C = function() {
...
//超声波Serial
Blockly.Arduino.qdp_ESP8266_chaoshengboSerial = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  ...
  if(mode=='0'){
    ...
    Blockly.Arduino.definitions_['var_declare_qdprobot_serial'+dropdown_pin] = 'SoftwareSerial  P'+dropdown_pin+'(P'+dropdown_pin+'L,P'+dropdown_pin+'R);';
...
'}\n'
  ...
  return [code, Blockly.Arduino.ORDER_ATOMIC];
    ...
    //巡线
Blockly.Arduino.qdp_ESP8266_grayscale = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
//光线
Blockly.Arduino.qdp_ESP8266_lightSensor = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
...
//声音
Blockly.Arduino.qdp_ESP8266_sound = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  var code = 'analogRead('+dropdown_pin+')';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
...
Blockly.Arduino.qdp_ESP8266_potentiometer = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  var code = 'analogRead('+dropdown_pin+')';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
  ...
  //土壤
Blockly.Arduino.qdp_ESP8266_Soilmoisture = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  var code = 'analogRead('+dropdown_pin+')';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
  ...
  //DH11温湿度
Blockly.Arduino.qdp_ESP8266_dht11 = function () {
  var dropdown_pin = this.getFieldValue('PIN');
  var what = this.getFieldValue('WHAT');
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  Blockly.Arduino.definitions_['include_DHT'] = '#include <DHT.h>';
  Blockly.Arduino.definitions_['var_declare_dht' + dropdown_pin] = 'DHT dht'+dropdown_pin+'('+dropdown_pin+', 11);'
...
//负载输出
Blockly.Arduino.qdp_ESP8266_Load_Output = function() {
  var dropdown_stat = Blockly.Arduino.valueToCode(this, 'STAT', Blockly.Arduino.ORDER_ATOMIC);
  Blockly.Arduino.setups_['setup_output2'] = 'pinMode(2, OUTPUT);';
...
Blockly.Arduino.qdp_ESP8266_ledlight = function() {
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = Blockly.Arduino.valueToCode(this, 'STAT', Blockly.Arduino.ORDER_ATOMIC);
  Blockly.Arduino.setups_['setup_output33_'+dropdown_pin] = 'pinMode('+dropdown_pin+', OUTPUT);';
...
Blockly.Arduino.qdp_ESP8266_read_ledlight = function() {
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.setups_['setup_output33_'+dropdown_pin] = 'pinMode('+dropdown_pin+', OUTPUT);';
  var code = 'digitalRead('+dropdown_pin+')'
...
Blockly.Arduino.qdp_ESP8266_ledlight3 = function() {
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  var dropdown_pin = this.getFieldValue('PIN');
  var ledn = Blockly.Arduino.valueToCode(this, 'ledn',Blockly.Arduino.ORDER_ATOMIC) || '0';
  var code = 'analogWrite('+dropdown_pin+','+ledn+');\n'
  return code;
};


//继电器板
Blockly.Arduino.qdp_ESP8266_relay = function() {
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = Blockly.Arduino.valueToCode(this, 'STAT', Blockly.Arduino.ORDER_ATOMIC);  
  Blockly.Arduino.setups_['setup_output33_'+dropdown_pin] = 'pinMode('+dropdown_pin+', OUTPUT);';
...
//读继电器板状态
Blockly.Arduino.qdp_ESP8266_read_relay = function() {
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.setups_['setup_output33_'+dropdown_pin] = 'pinMode('+dropdown_pin+', OUTPUT);';
  var code = 'digitalRead('+dropdown_pin+')'
...
//RBGLED
Blockly.Arduino.rgb_ESP8266_led = function() {
  ...
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  if(pin1 == 'P2R_start')
    Blockly.Arduino.definitions_['var_declare_var_rgb_display' + pin1] = 'Adafruit_NeoPixel QDPRGBLED_' + pin1 + '=Adafruit_NeoPixel('+ NUM8 +','+pin1+',NEO_RGB + NEO_KHZ800);';
  else
...
//RBGLED2
Blockly.Arduino.ESP8266_rgbled2=function(){
  var pin1 = this.getFieldValue('PIN1');
  var NUM=Blockly.Arduino.valueToCode(this, 'num1', Blockly.Arduino.ORDER_ATOMIC) || '0';
  var NUM8=Blockly.Arduino.valueToCode(this, 'num8', Blockly.Arduino.ORDER_ATOMIC) || '0';
  var rgblednum = Blockly.Arduino.valueToCode(this, 'rgblednum', Blockly.Arduino.ORDER_ATOMIC);
  ...
  if(NUM=='0')
  {
    var code = 'for (int il = 0; il < '+NUM8+'; il++)\nQDPRGBLED_' + pin1 + '.setPixelColor(il,'+color+');\nQDPRGBLED_'+ pin1 + '.show();\nQDPRGBLED_'+ pin1 + '.show();\ndelay(1);\n';
  }
  else
  {
...
//蜂鸣器
  ...
  Blockly.Arduino.qdp_ESP8266_buzzer3=function(){
  var dropdown_pin = this.getFieldValue('PIN'); 
  ...
  var code='tone('+dropdown_pin+','+dropdown_pin2+');\ndelay('+dur+');\nnoTone('+dropdown_pin+');\n';
  return code; 

};

//蜂鸣器停止发声
  Blockly.Arduino.qdp_ESP8266_stop_buzzer3=function(){
  var dropdown_pin = this.getFieldValue('PIN'); 
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
...
//蜂鸣器音乐
  Blockly.Arduino.qdp_ESP8266_buzzer_music=function(){
  var dropdown_pin2= this.getFieldValue('PIN2');
  var dropdown_pin = this.getFieldValue('PIN'); 
  var CHANNEL = this.getFieldValue("CHANNEL");
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  Blockly.Arduino.definitions_['define_ESP8266_tone'] = '#include <Tone8266.h>';
  Blockly.Arduino.definitions_['var_declare_Tone8266'] = 'Tone8266 Tone8266;';
  Blockly.Arduino.setups_['setup_output_'+dropdown_pin] = '';
  var code='Tone8266.buzzer_music('+dropdown_pin+','+dropdown_pin2+');\n';
  return code; 

};

  Blockly.Arduino.qdp_ESP8266_buzzer_musics=function(){
  var music = this.getFieldValue('music'); 
  var code=''+music+'';
  return [code,Blockly.Arduino.ORDER_ATOMIC];
...
//舵机360
Blockly.Arduino.qdp_ESP8266_servomotor360 = function() {
  var dropdown_pin = this.getFieldValue('pin');
  var dropdown_pin2 = this.getFieldValue('pin2');
  var num1 = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) || '0';
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  Blockly.Arduino.definitions_['define_ESP8266_Servo'] = '#include <Servo.h>';
  Blockly.Arduino.definitions_['var_declare_ServoPulseWith'] = 'uint16_t QDPServoPulseWith1(bool dir, uint8_t speed){\n'+
 'uint16_t pulselen = 0;\n'+
...
//舵机
Blockly.Arduino.qdp_ESP8266_servomotor2 = function() {
  var dropdown_pin = this.getFieldValue('pin');
...
Blockly.Arduino.qdp_ESP8266_servomotorread = function() {
  var dropdown_pin = this.getFieldValue('pin');
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  Blockly.Arduino.definitions_['define_Servo'] = '#include <Servo.h>';
  Blockly.Arduino.definitions_['var_declare_qdprobot_motor31'+dropdown_pin] = 'Servo QDPservo_'+dropdown_pin+';\n';
...
Blockly.Arduino.QDPESP8266Voice = function() {
  ...
  Blockly.Arduino.setups_['Voicesetup_output'] = 'digitalWrite(15,HIGH);';
  var code = 'VoiceSendData('+addr+',15);\ndelay('+delayTime+');\n'
  return code;
};

//语音模块读值

Blockly.Arduino.QDPESP8266VoicePlayValue = function() {
  Blockly.Arduino.definitions_['include_QDPVoice'] = '#include <QDPVoice.h>';
  var addr = Blockly.Arduino.valueToCode(this, 'addr',Blockly.Arduino.ORDER_ATOMIC) || '0';
  Blockly.Arduino.setups_['Voicesetup_output'] = 'digitalWrite(15,HIGH);';
  var code = 'VoicePlayValue('+addr+',15);\n'
  return code;
};
//语音模块
 ...
 //语音识别发送数据
Blockly.Arduino.QDP8266_ASR_SendData = function() {
  ...
  Blockly.Arduino.definitions_['var_declare_MyASR'+dropdown_pin2] = 'QDPASR MyASR'+dropdown_pin2+';';
  Blockly.Arduino.definitions_['var_declare_qdprobot_serial'+dropdown_pin2] = 'SoftwareSerial  P'+dropdown_pin2+'(P'+dropdown_pin2+'L, P'+dropdown_pin2+'R);';
  Blockly.Arduino.setups_['setup_qdprobot_serial'+dropdown_pin2] = 'P'+dropdown_pin2+'.begin(9600);';
  Blockly.Arduino.setups_['setup_qdprobot_serial3'+dropdown_pin2] = 'MyASR'+dropdown_pin2+'.begin(P'+dropdown_pin2+');';
  var code = 'MyASR'+dropdown_pin2+'.SendData(\"'+keyword+'\");\n';
  return code;
};

//语音识别对比数据
Blockly.Arduino.QDP8266_ASR_CompareData = function() {
  var dropdown_pin2 = this.getFieldValue('pinn');
  var keyword = this.getFieldValue('keyword');
...
//语音识别接收
Blockly.Arduino.QDP8266_ASR_ReceiveData = function() {
  var dropdown_pin2 = this.getFieldValue('pinn');
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  Blockly.Arduino.definitions_['include_QDPASR'] = '#include <QDPASR.h>';
  Blockly.Arduino.definitions_['include_SoftwareSerial'] = '#include <SoftwareSerial.h>';
  ...
  Blockly.Arduino.setups_['setup_qdprobot_serial'+dropdown_pin2] = 'P'+dropdown_pin2+'.begin(9600);';
  Blockly.Arduino.setups_['setup_qdprobot_serial3'+dropdown_pin2] = 'MyASR'+dropdown_pin2+'.begin(P'+dropdown_pin2+');';
  var code ='MyASR'+dropdown_pin2+'.ReceiveData();\n';
  return code;
 };

 //QF合成初始化

Blockly.Arduino.qdp_ESP8266_QF_hc_init = function() {
 var PIN = this.getFieldValue('PIN');

  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  Blockly.Arduino.definitions_['define_qdpxf'] = '#include <QDPQF.h>';
  Blockly.Arduino.definitions_['var_declare_qdprobot_qdpxfhs'] = 'QDPQF QFYY;\n';
  if(PIN=='Serial')
  {
    Blockly.Arduino.setups_['setup_qdprobot_serial']= 'Serial.begin(9600);';
    Blockly.Arduino.setups_['setup_qdprobot_eps32_HC_init'] ='QFYY.begin(Serial);';
  }
  else
  {
    Blockly.Arduino.definitions_['define_SoftwareSerial'] = '#include <SoftwareSerial.h>';
    Blockly.Arduino.definitions_['var_declare_ESP8266_Soft_wareSerial'+PIN] = 'SoftwareSerial swSer'+PIN+'(P'+PIN+'L, P'+PIN+'R);'; 
    Blockly.Arduino.setups_['setup_qdprobot_eps8266_Software_serial'+PIN] = 'swSer'+PIN+'.begin(9600);';
    Blockly.Arduino.setups_['setup_qdprobot_eps32_HC_init'] ='QFYY.begin(swSer'+PIN+');';
  }
...
Blockly.Arduino.qdp_ESP8266_QF_hc_en = function() {
...
return code;
 ...
 //QF提示音
Blockly.Arduino.qdp_ESP8266_QF_sound = function() {
  var dropdown_pin3 = this.getFieldValue('pin');
  var num = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var No = parseInt(dropdown_pin3)*100+parseInt(num);
  var code = 'QFYY.HC("[x1]sound'+No+'",1);\n';

  return code;
};

//QF停止合成
Blockly.Arduino.qdp_ESP8266_QF_stophc = function() {
 ...
 //QF启动识别
 Blockly.Arduino.qdp_ESP8266_QF_startstopsb = function() {
  var dropdown_pin4 = this.getFieldValue('PIN33');
  var code = 'QFYY.QDSB('+dropdown_pin4+');\n'; 

  return code;
 };

//QF识别结果
Blockly.Arduino.qdp_ESP8266_QF_sbjg = function() {
var number = Math.ceil(Math.random() * 100000);  
...
return [code, Blockly.Arduino.ORDER_ATOMIC];
 ...
 //QF识别结果2
Blockly.Arduino.qdp_ESP8266_QF_sbjg2 = function() {
  var number = Math.ceil(Math.random() * 100000);  
...
Blockly.Arduino.qdp_ESP8266_ir_re2 = function() {
...
Blockly.Arduino.qdp_ESP8266_ir_send_nec = function() {
  ...
  Blockly.Arduino.definitions_['var_declare_ir_send'+PIN] = 'IRsend irsend('+PIN+');';
...
//红外接收解码
Blockly.Arduino.qdp_ESP8266_ir_recv_raw = function () {
  var dropdown_pin = this.getFieldValue('PIN1');
...
//红外发送数组
Blockly.Arduino.qdp_ESP8266_ir_send_raw = function () {
   var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_pin2 = this.getFieldValue('PIN2');
  ...
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  Blockly.Arduino.definitions_['include_ir_send'] = '#include "IRsend.h"';
   Blockly.Arduino.definitions_['QDPir_send_raw1'+dropdown_pin]='#ifndef UNIT_TEST\n#include <Arduino.h>\n#endif\n#include <IRremoteESP8266.h>\n#define IR_LED '+dropdown_pin+'\n';

  Blockly.Arduino.definitions_['QDPir_send_raw2'+dropdown_pin]='IRsend irsend('+dropdown_pin+');\n'
  Blockly.Arduino.definitions_['QDPir_send_raw3'+dropdown_pin2]='uint16_t rawData'+dropdown_pin2+'[' + length + ']={' + text + '};\n';
  
 Blockly.Arduino.setups_['irsend_begin'] = 'irsend.begin();\nSerial.begin(115200, SERIAL_8N1, SERIAL_TX_ONLY);\n';

  var code = 'irsend.sendRaw(rawData'+dropdown_pin2+',' + length + ',' + freq + ');\ndelay(2000);\n';
  return code;
};
...
Blockly.Arduino.qdp_ESP8266_BT_START = function() {
  var PIN = this.getFieldValue('PIN');
  var PRINT = this.getFieldValue('PRINT');
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>'; 
  Blockly.Arduino.definitions_['include_AppEsp32BtRec'] = '#include <AppEsp32BtRec.h>';
   
  if(PIN=='Serial')
  {
    Blockly.Arduino.setups_['setup_qdprobot_serial']= 'Serial.begin(9600);';
    Blockly.Arduino.definitions_['var_declare_define_AppBtRec'] = 'AppBtRec AppBtRec(Serial,'+PRINT+');\n';
  }
  else
  {
    Blockly.Arduino.definitions_['define_SoftwareSerial'] = '#include <SoftwareSerial.h>';
    Blockly.Arduino.definitions_['var_declare_ESP8266_Soft_wareSerial'+PIN] = 'SoftwareSerial swSer'+PIN+'(P'+PIN+'L, P'+PIN+'R);'; 
    Blockly.Arduino.setups_['setup_qdprobot_eps8266_Software_serial'+PIN] = 'swSer'+PIN+'.begin(9600);';
    Blockly.Arduino.definitions_['var_declare_define_AppBtRec'] = 'AppBtRec AppBtRec(swSer'+PIN+','+PRINT+');\n';
  }
...
Blockly.Arduino.qdp_ESP8266_BT_button = function() {
...
Blockly.Arduino.qdp_ESP8266_BT_variable = function() {
  var dropdown_pin1 = this.getFieldValue('pin');
...
Blockly.Arduino.qdp_ESP8266_BT_print = function() {
  var PIN = this.getFieldValue('PIN');
  ...
  if(PIN=='Serial'){
    ...
    var code = "swSer"+PIN+".print(String(" + num1 + ")+','+String(" + num2 + ")+','+String(" + num3+ ")+','+String(" + num4 +")+','+String(" + num5 + "));\n";
  }
...
Blockly.Arduino.qdp_ESP8266_serial_jieshouzhi = function() {
  var PIN = this.getFieldValue('pin1');
  var num = Blockly.Arduino.valueToCode(this, 'text',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  if(PIN=='Serial')
  {
    Blockly.Arduino.definitions_['return_SoftwareSerial1'+PIN] = 'bool portReceived_P'+PIN+'(String inputStr) {\n'
    +'static String recStr = "";\n'
    +'if ('+PIN+'.available() > 0) {\n'
    +'  recStr = '+PIN+'.readString();\n'
    +'}\n'
    +'if (recStr.equals(inputStr)) {\n'
    +'  recStr = "";\n'
    +'  return true;\n'
    +'}\n'
    +'return false;\n'
    +'}\n';
    Blockly.Arduino.setups_['setup_qdprobot_serial']= 'Serial.begin(9600);';
    var code = 'portReceived_P'+PIN+'('+num+')';    
  }
  else
  {
    Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
    ...
    Blockly.Arduino.definitions_['return_SoftwareSerial1'+PIN] = 'bool portReceived_P'+PIN+'(String inputStr) {\n'
    +'static String recStr = "";\n'
    +'if (swSer'+PIN+'.available() > 0) {\n'
    +'  recStr = swSer'+PIN+'.readString();\n'
    +'}\n'
    +'if (recStr.equals(inputStr)) {\n'
    +'  recStr = "";\n'
    +'  return true;\n'
 ...
 //串口发送
Blockly.Arduino.qdp_ESP8266_serial_fasong = function() {
  var PIN = this.getFieldValue('pin1');
  var num = Blockly.Arduino.valueToCode(this, 'text',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  ...
  else
  {
    ...
    Blockly.Arduino.setups_['setup_qdprobot_eps8266_Software_serial'+PIN] = 'swSer'+PIN+'.begin(9600);';
    Blockly.Arduino.definitions_['var_declare_ESP8266_Soft_wareSerial'+PIN] = 'SoftwareSerial swSer'+PIN+'(P'+PIN+'L, P'+PIN+'R);'; 
    var code = 'swSer'+PIN+'.'+OutputModel+'('+num+');\n'; 
  }
  return code;
};

//串口接收
Blockly.Arduino.qdp_ESP8266_serial_jieshou = function() {
  var PIN = this.getFieldValue('pin1');
  if(PIN=='Serial')
  {
    Blockly.Arduino.setups_['setup_qdprobot_serial']= 'Serial.begin(9600);';
    var code = PIN+'.readString()'; 
  }
  else
  {
    Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
    ...
    Blockly.Arduino.setups_['setup_qdprobot_eps8266_Software_serial'+PIN] ='swSer'+PIN+'.begin(9600);';
    Blockly.Arduino.definitions_['var_declare_ESP8266_Soft_wareSerial'+PIN] = 'SoftwareSerial swSer'+PIN+'(P'+PIN+'L, P'+PIN+'R);'; 
    var code = 'swSer'+PIN+'.readString()'; 
  }
  return [code, Blockly.Arduino.ORDER_ATOMIC];
 };

 //串口有数据可读
Blockly.Arduino.qdp_ESP8266_serial_suju = function() {
  var PIN = this.getFieldValue('pin1');
  if(PIN=='Serial')
  {
    Blockly.Arduino.setups_['setup_qdprobot_serial']= 'Serial.begin(9600);';
    var code = PIN+'.available() > 0';
  }
  else
  {
    Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
    ...
    Blockly.Arduino.setups_['setup_qdprobot_eps8266_Software_serial'+PIN] ='swSer'+PIN+'.begin(9600);';
    Blockly.Arduino.definitions_['var_declare_ESP8266_Soft_wareSerial'+PIN] = 'SoftwareSerial swSer'+PIN+'(P'+PIN+'L, P'+PIN+'R);'; 
    var code = 'swSer'+PIN+'.available() > 0';
  }
 ...
 //MP3初始化
Blockly.Arduino.ESP8266_Mp3_init = function() {
  var PIN = this.getFieldValue('PIN');

  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  Blockly.Arduino.definitions_['define_SoftwareSerial'] = '#include <SoftwareSerial.h>';

  Blockly.Arduino.definitions_['define_qdprobot2'] = '#include <QDPRobotESP32PlayerMini.h>';
  Blockly.Arduino.definitions_['G1_var_declare_qdprobot_serial2'] = 'QDPRobotQDPPlayerMini myQDPPlayer;';
  
  if(PIN=='Serial')
  {
    Blockly.Arduino.setups_['setup_qdprobot_serial']= 'Serial.begin(9600);';
    Blockly.Arduino.setups_['setup_myQDPPlayer_begin'] = 'if (!myQDPPlayer.begin(Serial)) {\n   while(true);\n }';
  }
  else
  {
    Blockly.Arduino.definitions_['var_declare_ESP8266_Soft_wareSerial'+PIN] = 'SoftwareSerial swSer'+PIN+'(P'+PIN+'L, P'+PIN+'R);'; 
    Blockly.Arduino.setups_['setup_qdprobot_eps8266_Software_serial'+PIN] = 'swSer'+PIN+'.begin(9600);';
    Blockly.Arduino.setups_['setup_myQDPPlayer_begin'] = 'if (!myQDPPlayer.begin(swSer'+PIN+')) {\n   while(true);\n }';
  }
  
  Blockly.Arduino.setups_['setup_myQDPPlayer_setTimeOut'] = 'myQDPPlayer.setTimeOut(600);';
  var code ='';
  return code;
 };

  //MP3播放
 Blockly.Arduino.qdp_ESP8266_MP3_bofangx = function() {
  var num = Blockly.Arduino.valueToCode(this, 'num',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var num2 = Blockly.Arduino.valueToCode(this, 'num2',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
...
//MP3音量
Blockly.Arduino.qdp_ESP8266_MP3_yingliang = function() {
  var num = Blockly.Arduino.valueToCode(this, 'num',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var code ='myQDPPlayer.volume('+num+');\n ';
  return code;
 };
...
//MP3重复播放
 Blockly.Arduino.qdp_ESP8266_MP3_loopplay = function() {
...
Blockly.Arduino.qdp_ESP8266_MP3_startpause = function() {
...
//MP3上一首
Blockly.Arduino.qdp_ESP8266_MP3_previous_next = function() {
  var dropdown_pin3 = this.getFieldValue('PIN22');
...
//MP3播放音效
 Blockly.Arduino.qdp_ESP8266_MP3_play = function() {
  var dropdown_pin3 = this.getFieldValue('pin2');
  var num = Blockly.Arduino.valueToCode(this, 'num',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
...
Blockly.Arduino.qdp_ESP8266_define_mp3_directory = function() {
    var data = Blockly.Arduino.valueToCode(this, 'data',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    data = data.replace(/\"/g,'')
...
Blockly.Arduino.qdp_ESP8266_mp3_designated_play = function() {
    var mode = this.getFieldValue('mode');
...
//数码管显示 
Blockly.Arduino.qdp_ESP8266_display = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_pin2 = this.getFieldValue('PIN2');
  ...
  Blockly.Arduino.setups_['setup_qdprobot_display1'+dropdown_pin] = 'QDP7SegmentDisplay'+dropdown_pin+'.begin();\nQDP7SegmentDisplay'+dropdown_pin+'.setBacklight(50);\n';
 if (dropdown_pin2==0)
 {
  var code = 'QDP7SegmentDisplay'+dropdown_pin+'.print('+VALUE+');\n';
 }
  else
  {
    var code = 'QDP7SegmentDisplay'+dropdown_pin+'.print(int('+VALUE+'));\n';
  }
...
//数码管清屏
Blockly.Arduino.qdp_ESP8266_display_clear = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var code = 'QDP7SegmentDisplay'+dropdown_pin+'.clear();\n';
  return code;
};

//关闭数码管

Blockly.Arduino.qdp_ESP8266_displayoff = function() {
  var dropdown_pin2 = this.getFieldValue('pinn');
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  Blockly.Arduino.definitions_['include_SevenSegmentTM1637'] = '#include <SevenSegmentTM1637.h>';
  var code = 'QDP7SegmentDisplay'+dropdown_pin2+'.clear();\n';
  return code;
};

Blockly.Arduino.qdp_ESP8266_display_TM1637_init = function () {
  var PIN = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
  Blockly.Arduino.definitions_['include_SevenSegmentTM1637'] = '#include <SevenSegmentTM1637.h>';
  Blockly.Arduino.definitions_['var_declare_SevenSegmentTM1637'] = 'SevenSegmentTM1637  display(P' + PIN + 'L,P' + PIN + 'R);';
...
Blockly.Arduino.display_TM1637_displayTime = function () {
    ...
    Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
    Blockly.Arduino.definitions_['var_declare_SevenSegmentTM1637'] = 'SevenSegmentExtended  display(P' + dropdown_pin + 'L,P' + dropdown_pin + 'R);';
...
Blockly.Arduino.ESP8266_oled_init = function() {
  var PIN = this.getFieldValue('PIN');
...
if(PIN == "1")
  ...
  {
    Blockly.Arduino.definitions_['var_declare_U8G2'] ='U8G2_SSD1306_128X64_NONAME_F_SW_I2C u8g2(U8G2_R0,  P'+PIN+'R, P'+PIN+'L,U8X8_PIN_NONE);';
Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
}
...
Blockly.Arduino.ESP8266_oled_page = function() {
  var branch = Blockly.Arduino.statementToCode(this, 'DO');
...
Blockly.Arduino.ESP8266_oled_set_EN_Font = function() {
...
Blockly.Arduino.ESP8266_oled_print = function() {
...
Blockly.Arduino.ESP8266_oled_set_CN_Font = function() {
  var FONT_NAME = this.getFieldValue('FONT_NAME');
  var FONT_SIZE = this.getFieldValue('FONT_SIZE');
...
Blockly.Arduino.ESP8266_oled_define_bitmap_data = function() {
...
Blockly.Arduino.ESP8266_oled_clear = function() {
  var code="u8g2.clearDisplay();\n";
  return code;
};

//返回UTF8字符串宽度
Blockly.Arduino.QDP_getutf8width = function() {
    var str= Blockly.Arduino.valueToCode(this, 'str', Blockly.Arduino.ORDER_ATOMIC);
...
Blockly.Arduino.ESP8266_oled_showBitmap = function() {
...
Blockly.Arduino.ESP8266_oled_drawPixel = function() {
  var pos_x = Blockly.Arduino.valueToCode(this, 'POS_X') || '0';
  var pos_y = Blockly.Arduino.valueToCode(this, 'POS_Y') || '0';
  var code = "";
...
Blockly.Arduino.ESP8266_oled_drawLine = function() {
  var start_x = Blockly.Arduino.valueToCode(this, 'START_X') || '0';
  var start_y = Blockly.Arduino.valueToCode(this, 'START_Y') || '0';
...
Blockly.Arduino.ESP8266_oled_draw_Str_Line = function() {
  var start_x = Blockly.Arduino.valueToCode(this, 'START_X') || '0';
  var start_y = Blockly.Arduino.valueToCode(this, 'START_Y') || '0';
...
Blockly.Arduino.ESP8266_oled_drawFrame = function() {
...
Blockly.Arduino.ESP8266_oled_drawRFrame = function() {
  var D0_x = Blockly.Arduino.valueToCode(this, 'D0_X') || '0';
  var D0_y = Blockly.Arduino.valueToCode(this, 'D0_Y') || '0';
  var Width = Blockly.Arduino.valueToCode(this, 'WIDTH') || '0';
  var Height = Blockly.Arduino.valueToCode(this, 'HEIGHT') || '0';
...
Blockly.Arduino.ESP8266_oled_drawCircle = function() {
  var D0_x = Blockly.Arduino.valueToCode(this, 'D0_X') || '0';
  var D0_y = Blockly.Arduino.valueToCode(this, 'D0_Y') || '0';
  var Rauius = Blockly.Arduino.valueToCode(this, 'RADIUS') || '0';
  var type = this.getFieldValue('TYPE');
...
Blockly.Arduino.ESP8266_oled_drawEllipse = function() {
  var D0_x = Blockly.Arduino.valueToCode(this, 'D0_X') || '0';
  var D0_y = Blockly.Arduino.valueToCode(this, 'D0_Y') || '0';
...
Blockly.Arduino.ESP8266_oled_drawTriangle = function() {
  var D0_x = Blockly.Arduino.valueToCode(this, 'D0_X') || '0';
  var D0_y = Blockly.Arduino.valueToCode(this, 'D0_Y') || '0';
...
Blockly.Arduino.QDP_ESP8266_group_lcd_init2 = function() {
  var varName = Blockly.Arduino.valueToCode(this, 'VAR') || '0';
  varName = varName.replace(/\"/g,'')
  var TYPE = this.getFieldValue('TYPE');
  var PIN = this.getFieldValue('PIN');
  ...
  else
  {
      ...
      Blockly.Arduino.definitions_['var_declare_LiquidCrystal_I2C_'+varName] = 'LiquidCrystal_I2C '+varName+'('+device+','+TYPE+');';
      Blockly.Arduino.setups_["setup_Wire"] ='Wire.begin(P' +PIN+ 'L,P' +PIN+ 'R);';
 ...
 //LCD打印
  ...
  Blockly.Arduino.group_lcd_power = function() {
   ...
   //小彩屏初始化
Blockly.Arduino.QDP_ESP8266_display_samll_init = function() {
  var PIN = this.getFieldValue('PIN');
  if(PIN=='Serial')
  {
    Blockly.Arduino.setups_['setup_qdprobot_serial']= 'Serial.begin(9600);';
  ...
  else
  {
    Blockly.Arduino.definitions_['define_QDPEsp8266Port'] = '#include <QDPEsp8266Port.h>';
    Blockly.Arduino.definitions_['define_SoftwareSerial'] = '#include <SoftwareSerial.h>';
    Blockly.Arduino.definitions_['var_declare_ESP8266_Soft_wareSerial'+PIN] = 'SoftwareSerial swSer'+PIN+'(P'+PIN+'R, P'+PIN+'L);'; 
    Blockly.Arduino.setups_['setup_qdprobot_eps8266_Software_serial'+PIN] = 'swSer'+PIN+'.begin(9600);';
  }
 ...
 //彩屏刷新显示
Blockly.Arduino.QDP_ESP8266_display_samll_refresh_display = function() {
  var PIN = this.getFieldValue('PIN');
  var branch = Blockly.Arduino.statementToCode(this, 'DO');
  branch = branch.replace(/(^\s*)|(\s*$)/g, "");//去除两端空格
  if(PIN=='Serial'){
    var code = branch+PIN+'.println("");\n'; 
  }else{
    var code = branch+'\nswSer'+PIN+'.println("");\n'; 
  }
 ...
 //小彩屏横竖屏设置
Blockly.Arduino.QDP_ESP8266_display_samll_HV = function() {
  var PIN = this.getFieldValue('PIN');
  var dropdown_pin3 = this.getFieldValue('pin');
  if(PIN=='Serial')
    var code = PIN+'.print("DIR('+dropdown_pin3+');");\n';
  else
    var code = 'swSer'+PIN+'.print("DIR('+dropdown_pin3+');");\n';
  return code;
 };

  //屏亮度设置
 Blockly.Arduino.QDP_ESP8266_display_samll_BL = function() {
  var PIN = this.getFieldValue('PIN');
  var num = Blockly.Arduino.valueToCode(this, 'QDP_display_samll_bl_1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  if(PIN=='Serial')
    var code = PIN+'.print(String("BL(")+String('+num+')+String(");"));\n';
  else
    var code = 'swSer'+PIN+'.print(String("BL(")+String('+num+')+String(");"));\n';
  return code;
 };

 //小彩屏颜色刷屏
 Blockly.Arduino.QDP_ESP8266_display_samll_clr = function() {
  var PIN = this.getFieldValue('PIN');
  var dropdown_pin3 = this.getFieldValue('pin');

  var num = Blockly.Arduino.valueToCode(this, 'QDP_display_samll_clr_1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  if(PIN=='Serial')
    var code = PIN+'.print(String("'+dropdown_pin3+'(")+String('+num+')+String(");"));\n';
  else
    var code = 'swSer'+PIN+'.print(String("'+dropdown_pin3+'(")+String('+num+')+String(");"));\n';
  return code;
 };

 //小彩屏图片显示
Blockly.Arduino.QDP_ESP8266_display_samll_flash_pic = function() {
  var PIN = this.getFieldValue('PIN');
  ...
  if(PIN=='Serial')
    var code = PIN+'.print(String("FSIMG(")+String('+picNum+')+String(",0,0,")+String('+W+')+String(",")+String('+H+')+String(",")+String('+model+')+String(");"));\n';
  else
    var code = 'swSer'+PIN+'.print(String("FSIMG(")+String('+picNum+')+String(",0,0,")+String('+W+')+String(",")+String('+H+')+String(",")+String('+model+')+String(");"));\n';
  return code;
 };

 //小彩屏图片显示
 Blockly.Arduino.QDP_ESP8266_display_samll_pic = function() {
  var PIN = this.getFieldValue('PIN');
  var dropdown_pin3 = this.getFieldValue('pin');
  ...
  if(PIN=='Serial')
   var code = PIN+'.print(String("FSIMG(")+String('+num1+')+String(",")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(",")+String('+num5+')+String(",")+String('+dropdown_pin3+')+String(");"));\n';
  else
    var code = 'swSer'+PIN+'.print(String("FSIMG(")+String('+num1+')+String(",")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(",")+String('+num5+')+String(",")+String('+dropdown_pin3+')+String(");"));\n';
  return code;
 };

//小彩屏画点指令
 Blockly.Arduino.QDP_ESP8266_display_samll_PS = function() {
  var PIN = this.getFieldValue('PIN');
  ...
  if(PIN=='Serial')
    var code = PIN+'.print(String("PS(")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(");"));\n';
  else
    var code = 'swSer'+PIN+'.print(String("PS(")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(");"));\n';
  return code;
 };


//小彩屏画线框
 Blockly.Arduino.QDP_ESP8266_display_samll_PL = function() {
  var PIN = this.getFieldValue('PIN');
  var dropdown_pin3 = this.getFieldValue('pin');
  ...
  if(PIN=='Serial')
    var code = PIN+'.print(String("'+dropdown_pin3+'(")+String('+num1+')+String(",")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(",")+String('+num5+')+String(");"));\n';
  else
    var code = 'swSer'+PIN+'.print(String("'+dropdown_pin3+'(")+String('+num1+')+String(",")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(",")+String('+num5+')+String(");"));\n';

  return code;
 };

//小彩屏画圆
 Blockly.Arduino.QDP_ESP8266_display_samll_CIR = function() {
  var PIN = this.getFieldValue('PIN');
  var dropdown_pin3 = this.getFieldValue('pin');
  ...
  if(PIN=='Serial')
    var code = PIN+'.print(String("'+dropdown_pin3+'(")+String('+num1+')+String(",")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(");"));\n';
  else
    var code = 'swSer'+PIN+'.print(String("'+dropdown_pin3+'(")+String('+num1+')+String(",")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(");"));\n';
  return code;
 };

 //显示文本
 Blockly.Arduino.QDP_ESP8266_display_samll_DC = function() {
  var PIN = this.getFieldValue('PIN');
  var dropdown_pin3 = this.getFieldValue('pin');
  ...
  if(PIN=='Serial')
    var code = PIN+'.print(String("DC'+dropdown_pin3+'(")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(",")+String('+num1+')+String(");"));\n';
  else
    var code = 'swSer'+PIN+'.print(String("DC'+dropdown_pin3+'(")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(",")+String('+num1+')+String(");"));\n';

  return code;
 };

 //显示带底色文本
 Blockly.Arduino.QDP_ESP8266_display_samll_SBCDC = function() {
  var PIN = this.getFieldValue('PIN');
  var dropdown_pin3 = this.getFieldValue('pin');
  ...
  if(PIN=='Serial')
    var code = PIN+'.print(String("SBC('+num5+');DCV'+dropdown_pin3+'(")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(",")+String('+num1+')+String(");"));\n';
  else
    var code = 'swSer'+PIN+'.print(String("SBC('+num5+');DCV'+dropdown_pin3+'(")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(",")+String('+num1+')+String(");"));\n';
...
//自定指令
 Blockly.Arduino.QDP_ESP8266_display_samll_order = function() {
  var PIN = this.getFieldValue('PIN');
  var text = Blockly.Arduino.valueToCode(this, 'text',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  if(PIN=='Serial')
    var code = PIN+'print('+text+'+String(");"));\n';
  else
    var code = 'swSer'+PIN+'.print('+text+'+String(");"));\n';
 ...
 //小彩屏波特率设置
 Blockly.Arduino.QDP_ESP8266_display_samll_btl = function() {
  var PIN = this.getFieldValue('PIN');
  var dropdown_pin3 = this.getFieldValue('pin');
  if(PIN=='Serial')
    var code = PIN+'.print("BPS('+dropdown_pin3+');");\n';
  else
    var code = 'swSer'+PIN+'.print("BPS('+dropdown_pin3+');");\n';

  return code;
 };

 Blockly.Arduino.qdp_ESP8266_ZKDisplay_init = function() {
  var PIN = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['define_ZKDisplay'] = '#include <ZKDisplay.h>';
  ...
  if(PIN=='Serial')
  {
    Blockly.Arduino.definitions_['var_declare_qdprobot_qdpzkp'+PIN] = 'ZKDisplay ZKDisplay(Serial);\n';
    Blockly.Arduino.setups_['setup_qdprobot_serial']= 'Serial.begin(9600);';   
  }
  else
  {
    Blockly.Arduino.definitions_['define_SoftwareSerial'] = '#include <SoftwareSerial.h>';
    Blockly.Arduino.definitions_['var_declare_ESP8266_Soft_wareSerial'+PIN] = 'SoftwareSerial swSer'+PIN+'(P'+PIN+'L, P'+PIN+'R);'; 
    Blockly.Arduino.definitions_['var_declare_qdprobot_qdpzkp'+PIN] = 'ZKDisplay ZKDisplay(swSer'+PIN+');\n';
    Blockly.Arduino.setups_['setup_qdprobot_eps8266_Software_serial'+PIN] = 'swSer'+PIN+'.begin(9600);';
...
Blockly.Arduino.qdp_ESP8266_display_START = function() {
  var code = 'ZKDisplay.PortReceive();\n';
  return code;
  };
...
Blockly.Arduino.qdp_ESP8266_display_button = function() {
  var num = Blockly.Arduino.valueToCode(this, 'TEXT',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var code = 'ZKDisplay.IsObject('+num+')';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
  };
...
Blockly.Arduino.qdp_ESP8266_display_variable = function() {
  var dropdown_pin1 = this.getFieldValue('pin');

  var code = 'ZKDisplay.GetVal('+dropdown_pin1+')';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
  };
...
Blockly.Arduino.qdp_ESP8266_display_print = function() {
  var dropdown_pin1 = this.getFieldValue('pin');
  var num1 = Blockly.Arduino.valueToCode(this, 'N1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var code = 'ZKDisplay.CMD("t'+dropdown_pin1+'.txt=\\""+String('+num1+')+"\\"");\n';
  return code;
  };

//睡眠控制
 Blockly.Arduino.qdp_ESP8266_zkpdisplay_sleep = function() {
  var dropdown_pin2 = this.getFieldValue('pin2');
  var code = 'ZKDisplay.CMD("sleep='+dropdown_pin2+'");\n';
  return code;
 };
...
//屏蜂鸣器
 Blockly.Arduino.qdp_ESP8266_zkpdisplay_buzzer = function() {
  var dropdown_pin = this.getFieldValue('pin2');
  var num = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var code = 'ZKDisplay.CMD("cfgpio 7,3,0,pwmf=("+String('+dropdown_pin+')+"),pwm7=("+String('+num+')+")");\n';
  return code;
 };

 //颜色
 Blockly.Arduino.qdp_ESP8266_zkpdisplay_color = function() {
  var dropdown_pin = this.getFieldValue('pin1');
var code = ''+dropdown_pin+'';
 return [code, Blockly.Arduino.ORDER_ATOMIC];
 };
 ...
 //颜色刷屏
 Blockly.Arduino.qdp_ESP8266_zkpdisplay_clscolor = function() {
  var num = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var code = 'ZKDisplay.CMD(String("cls ")+String('+num+'));\n';
  return code;
 };
//表情刷屏
Blockly.Arduino.qdp_ESP8266_zkpdisplay_pic = function() {
  var dropdown_pin = this.getFieldValue('pin2');
  var code = 'ZKDisplay.CMD("pic 0,0,'+dropdown_pin+'");\n';
  return code;
 };

 //页面跳转
Blockly.Arduino.qdp_ESP8266_zkpdisplay_page = function() {
  var dropdown_pin = this.getFieldValue('pin2');
  var code = 'ZKDisplay.CMD("page '+dropdown_pin+'");\n'
  return code;
 };

 //画圆
 Blockly.Arduino.qdp_ESP8266_zkpdisplay_drawinground = function() {
  var dropdown_pin = this.getFieldValue('pin2');
  var num1 = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var num2 = Blockly.Arduino.valueToCode(this, 'num2',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var num3 = Blockly.Arduino.valueToCode(this, 'num3',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var num4 = Blockly.Arduino.valueToCode(this, 'num4',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var code = 'ZKDisplay.CMD("'+dropdown_pin+' "+String('+num1+')+","+String('+num2+')+","+String('+num3+')+","+String('+num4+'));\n'

  return code;
 };

 //画线矩形区域填充
 Blockly.Arduino.qdp_ESP8266_zkpdisplay_function1 = function() {
  var dropdown_pin = this.getFieldValue('pin2');
  var num1 = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var num2 = Blockly.Arduino.valueToCode(this, 'num2',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var num3 = Blockly.Arduino.valueToCode(this, 'num3',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  ...
  var code = 'ZKDisplay.CMD("'+dropdown_pin+' "+String('+num1+')+","+String('+num2+')+","+String('+num3+')+","+String('+num4+')+","+String('+num5+'));\n'
  return code;
 };

 //文字信息
 Blockly.Arduino.qdp_ESP8266_zkpdisplay_TEXT = function() {
  var num1 = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var num2 = Blockly.Arduino.valueToCode(this, 'num2',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var num3 = Blockly.Arduino.valueToCode(this, 'num3',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var num4 = Blockly.Arduino.valueToCode(this, 'num4',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  ...
  var code = 'ZKDisplay.CMD("xstr "+String('+num1+')+","+String('+num2+')+","+String('+num3+')+","+String('+num4+')+",0,"+String('+num5+')+","+String('+num6+')+",1,1,"+String('+dropdown_pin+')+",\\""+String('+num7+')+"\\"");\n';
  return code;
 };
 //文字信息
Blockly.Arduino.qdp_ESP8266_zkpdisplay_TEXT_CN = function() {
  var number = Math.ceil(Math.random() * 100000);  
  var num1 = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var num2 = Blockly.Arduino.valueToCode(this, 'num2',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  var num3 = Blockly.Arduino.valueToCode(this, 'num3',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  ...
  Blockly.Arduino.definitions_['var_declare_'+number] = 'char Str_'+number+'[] = {'+num7+'};';//定义数组
  var code = 'ZKDisplay.TextCn('+num1+','+num2+','+num3+','+num4+','+num5+','+num6+','+dropdown_pin+',Str_'+number+',sizeof(Str_'+number+'));\n'
  return code;
 };

//自定义指令
Blockly.Arduino.qdp_ESP8266_zkpdisplay_order = function() {
  var text = Blockly.Arduino.valueToCode(this, 'text',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  Blockly.Arduino.setups_['setup_qdprobot_serial']= 'Serial.begin(9600);';
  var code = 'ZKDisplay.CMD('+text+');\n';
  return code;
 };

 //EEPROM初始化
Blockly.Arduino.QDP8266_EEPROM_INIT = function() {
    var size= Blockly.Arduino.valueToCode(this, 'size', Blockly.Arduino.ORDER_ATOMIC);
    Blockly.Arduino.definitions_['define_KeyValueEEPROM_SIZE'] ='#define KeyValueEEPROM_SIZE '+size;
    Blockly.Arduino.definitions_['include_KeyValueEEPROM'] ='#include <KeyValueEEPROM.h>';
    Blockly.Arduino.setups_['setup_KeyValueEEPROM_begin'] = 'KeyValueEEPROM.begin();';
    var code='';
    return code;
};

//EEPROM KEY是否存在
Blockly.Arduino.QDP8266_EEPROM_exists = function() {
    var key= Blockly.Arduino.valueToCode(this, 'key', Blockly.Arduino.ORDER_ATOMIC);
    var code='KeyValueEEPROM.exists('+key+')';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
};

//EEPROM 设置数据
Blockly.Arduino.QDP8266_EEPROM_set = function() {
    var key= Blockly.Arduino.valueToCode(this, 'key', Blockly.Arduino.ORDER_ATOMIC);
    var value= Blockly.Arduino.valueToCode(this, 'value', Blockly.Arduino.ORDER_ATOMIC);
    var type = this.getFieldValue('TYPE');
    var code='KeyValueEEPROM.set<'+type+'>('+key+','+value+' );\n';
    return code;
};

//EEPROM 清除数据
Blockly.Arduino.QDP8266_EEPROM_clear = function() {
    var code='KeyValueEEPROM.clear();\n';
    return code;
};

//EEPROM 提交数据
Blockly.Arduino.QDP8266_EEPROM_apply = function() {
    var code='KeyValueEEPROM.apply();\n';
    return code;
};

//EEPROM 读取数据
Blockly.Arduino.QDP8266_EEPROM_get = function() {
    var key= Blockly.Arduino.valueToCode(this, 'key', Blockly.Arduino.ORDER_ATOMIC);
    var value= Blockly.Arduino.valueToCode(this, 'value', Blockly.Arduino.ORDER_ATOMIC);
    var type = this.getFieldValue('TYPE');
    var code='KeyValueEEPROM.get<'+type+'>('+key+')';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
};

//读取EEROM字符串
Blockly.Arduino.QDP_read_eerom_string = function() {
    Blockly.Arduino.definitions_['include_EEPROM'] ='#include "EEPROM.h"';
    Blockly.Arduino.definitions_['eerom_string_write'] = 'int addr = 0;\n#define EEPROM_SIZE 64\nchar String_data[64] = "Think Different";\n';   
    Blockly.Arduino.definitions_['read_eerom_string'] = 'String read_eerom_string() {\n    String readValueChar;\n    for (int i = 0; i < EEPROM_SIZE; i++) {\n        byte readValue = EEPROM.read(i);\n        if (readValue == 0) {\n            break;\n        }\n        readValueChar = String(readValueChar) + String(char(readValue));\n    }\n    return String(readValueChar);\n}\n';
    Blockly.Arduino.setups_['read_eerom_string_and_eerom_string_write'] ='Serial.begin(9600);\n  EEPROM.begin(EEPROM_SIZE);\n';       
    var code = 'read_eerom_string()';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
};

//EEROM字符串写入
Blockly.Arduino.QDP_eerom_string_write = function() {
    Blockly.Arduino.definitions_['include_EEPROM'] ='#include "EEPROM.h"';
    Blockly.Arduino.definitions_['eerom_string_write'] = 'int addr = 0;\n#define EEPROM_SIZE 64\nchar String_data[64] = "Think Different";\n';   
    Blockly.Arduino.setups_['read_eerom_string_and_eerom_string_write'] ='Serial.begin(9600);\n  EEPROM.begin(EEPROM_SIZE);\n';       
    var data= Blockly.Arduino.valueToCode(this, 'data', Blockly.Arduino.ORDER_ATOMIC);
    var code='    String('+data+').toCharArray(String_data, sizeof(String_data));\n    for (int i = 0; i < EEPROM_SIZE; i++) {\n        EEPROM.write(addr, String_data[i]);\n        addr += 1;\n    }\n    addr = 0;\n    EEPROM.commit();\n';
    return code;
};

//列表
Blockly.Arduino.qdp_create_list = function() {
  var Name = Blockly.Arduino.valueToCode(this, 'Name', Blockly.Arduino.ORDER_ATOMIC);
  var type= this.getFieldValue('type');
  var list_name = this.getFieldValue('list_name');
  Blockly.Arduino.definitions_['include_QList'] = '#include <QList.h>';
  Blockly.Arduino.definitions_['var_declare_QList'+list_name] = 'QList<'+type+'> '+list_name+';';
  var code = '';
  return code;
 };

Blockly.Arduino.qdp_list_length = function() {
  var list_name = this.getFieldValue('list_name');
  var code = ''+list_name+'.size()';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
 };

Blockly.Arduino.qdp_list_item = function() {
  var item = Blockly.Arduino.valueToCode(this, 'item', Blockly.Arduino.ORDER_ATOMIC);
  var list_name = this.getFieldValue('list_name');
  var code = ''+list_name+'.at('+item+')';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
 };

Blockly.Arduino.qdp_list_assignment = function() {
  var item = Blockly.Arduino.valueToCode(this, 'item', Blockly.Arduino.ORDER_ATOMIC);
  var value = Blockly.Arduino.valueToCode(this, 'value', Blockly.Arduino.ORDER_ATOMIC);
  var type= this.getFieldValue('type');
  var list_name = this.getFieldValue('list_name');
  var code = ''+list_name+'.at('+item+') = '+value+';\n';
  return code;
 };

Blockly.Arduino.qdp_add_data_to_the_list = function() {
  var data = Blockly.Arduino.valueToCode(this, 'data', Blockly.Arduino.ORDER_ATOMIC);
  var type= this.getFieldValue('type');
  var list_name = this.getFieldValue('list_name');
  var code = ''+list_name+'.'+type+'('+data+');\n';
  return code;
 };

Blockly.Arduino.qdp_list_clear = function() {
  var list_name = this.getFieldValue('list_name');
  var code = ''+list_name+'.clear();\n';
  return code;
 };

 Blockly.Arduino.qdp_clear_list_item = function() {
  var item = Blockly.Arduino.valueToCode(this, 'item', Blockly.Arduino.ORDER_ATOMIC);
  var list_name = this.getFieldValue('list_name');
  var code = ''+list_name+'.clear('+item+');\n';
  return code;
 };

 //ESP一键配网
Blockly.Arduino.QDP_esp8266_smartConfig = function() {
  ...
  Blockly.Arduino.setups_['MonEsp_smartConfig'] = 'MonEsp.smartConfig();';
  var code = "";
  return code;
};

//ESP一键配网
Blockly.Arduino.QDP_esp8266_smartConfig_ = function() {
...
//esp配置访问点
Blockly.Arduino.QDP_esp8266_config_access_point = function() {
  ...
  Blockly.Arduino.definitions_['include_QDP_ESP_WIFI'] = '#include <QDP_ESP_WIFI.h>';
  Blockly.Arduino.definitions_['var_declare_QDP_ESP_WIFI'] = 'QDP_ESP_WIFI MonEsp;';
  Blockly.Arduino.setups_['config_connect_AP_setup'] = 'MonEsp.connect_AP('+ssid+','+pwd+');';
  var code = "";
...
//wifi连接状态
Blockly.Arduino.QDP_WiFi_status = function() {
  var code = '!(WiFi.status() != WL_CONNECTED)';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

 //WIFI IP
  Blockly.Arduino.QDP_esp32_wifi_IP = function() {
  ...
  //esp配置访问点
Blockly.Arduino.QDP_esp8266_config_station = function() {
  var ssid = Blockly.Arduino.valueToCode(this, 'ssid', Blockly.Arduino.ORDER_ATOMIC);
  var pwd = Blockly.Arduino.valueToCode(this, 'pwd', Blockly.Arduino.ORDER_ATOMIC);
  Blockly.Arduino.definitions_['include_QDP_ESP_WIFI'] = '#include <QDP_ESP_WIFI.h>';
  Blockly.Arduino.definitions_['var_declare_QDP_ESP_WIFI'] = 'QDP_ESP_WIFI MonEsp;';
...
//发送邮件初始化
Blockly.Arduino.QDP_EMailSender_init = function() {
  var email_login = Blockly.Arduino.valueToCode(this, 'email_login', Blockly.Arduino.ORDER_ATOMIC);
  var email_password = Blockly.Arduino.valueToCode(this, 'email_password', Blockly.Arduino.ORDER_ATOMIC);

  var mailType = this.getFieldValue('mailType');
  var smtp_server = '';
  var smtp_port = '';
  switch(mailType)
  {
  ...
  Blockly.Arduino.definitions_['include_EMailSender'] ='#include <EMailSender.h>';
  Blockly.Arduino.definitions_['var_declare_EMailSender'] = 'EMailSender emailSend('+email_login+', '+email_password+', '+email_login+', "'+smtp_server+'",'+smtp_port+');';
  var code = '';   
  return code;
};

//发送邮件
Blockly.Arduino.QDP_EMailSender_send = function() {
  ...
  var email_to = Blockly.Arduino.valueToCode(this, 'email_to', Blockly.Arduino.ORDER_ATOMIC);

  Blockly.Arduino.definitions_['var_sendEmail'] = 'void send_email(String email_subject, String email_message, String email_Receiver) {\n'+
'  EMailSender::EMailMessage message;\n'+
'  message.subject = String(email_subject);\n'+
'  message.message = String(email_message);\n'+
'  EMailSender::Response resp = emailSend.send(String(email_Receiver).c_str(), message);\n'+
'  Serial.println("Sending status: ");\n'+
'  Serial.println(resp.status);\n'+
'  Serial.println(resp.code);\n'+
'  Serial.println(resp.desc);\n'+
'}\n';
  var code = 'send_email('+subject+', '+message+', '+email_to+');\n';   
  return code;
};

//配置域名
Blockly.Arduino.QDP_esp8266_config_domaine_name_mDNS = function() {
  var domaine_name = Blockly.Arduino.valueToCode(this, 'domaine_name', Blockly.Arduino.ORDER_ATOMIC);
  Blockly.Arduino.definitions_['include_mDNS'] ='#ifdef ESP32\n'+
  '#include <ESPmDNS.h>\n'+
  '#elif defined ESP8266\n'+
  '#include <ESP8266mDNS.h>\n'+
  '#endif';
  Blockly.Arduino.setups_['esp8266_MDNS_setup'] = 'if (!MDNS.begin('+domaine_name+')) \n'+
    'Serial.println("Error setting up MDNS responder!");\nMDNS.addService("http", "tcp", 80);\n'
  var code = 'MDNS.update();\n';
  return code;
};

//ESP8266重启
Blockly.Arduino.QDP_esp8266rst = function() {
  var code='ESP.restart();\n';
  return code;
};

Blockly.Arduino.QDP8266_set_mac_address = function () {
    var mac_address= Blockly.Arduino.valueToCode(this, 'mac_address', Blockly.Arduino.ORDER_ATOMIC);
    mac_address = ':' + mac_address + '';
    mac_address = mac_address.replace(/\"/g, "").replace(/\:/g,",0x");
    mac_address = ':' + mac_address + '';
...
//esp_now发送数据
Blockly.Arduino.QDP_esp_now_send = function () {
...
//esp_now接收数据
Blockly.Arduino.QDP_esp_now_receive = function () {
  ...
  //获取两个日期差值
Blockly.Arduino.QDP_get_the_number_of_days_between_the_two_dates = function() {
...
//     //定时器
// Blockly.Arduino.C02_controls_hw_timer = function () {    
...
// Blockly.Arduino.C02_controls_hw_timer_start = function () {
//   var time = Blockly.Arduino.valueToCode(this, 'TIME', Blockly.Arduino.ORDER_ATOMIC);
//   var mode = this.getFieldValue('mode');
//   var TIMER_NUM = this.getFieldValue('TIMER_NUM');
//   return 'timerAlarmWrite(timer'+TIMER_NUM+', '+time+'*1000L, '+mode+');\ntimerRestart(timer'+TIMER_NUM+');\ntimerAlarmEnable(timer'+TIMER_NUM+');\n';
// };

// Blockly.Arduino.C02_controls_hw_timer_stop = function () {
//    var TIMER_NUM = this.getFieldValue('TIMER_NUM');
//    return 'timerAlarmDisable(timer'+TIMER_NUM+');\n';
// };

//执行器定时器
Blockly.Arduino.qdp_timer = function () {
...
//定义变量
    ...
    Blockly.Arduino.QDP_ESP8266_Task = function () {
  ...
  for(var i of xmlText)
  {
    ...
    var left_indexOf = output_data.indexOf("<blocktype=\"QDP_ESP8266_Task\"><fieldname=\"task\">"+task+"</field>");
    var right_indexOf = output_data.lastIndexOf("<blocktype=\"QDP_ESP8266_Task\"><fieldname=\"task\">"+task+"</field>");
    ...
    {
        this.setWarningText("警告：\n该模块的编号不可重复，\n请考虑修改此模块的编号或删除此模块。");
    }
    Blockly.Arduino.definitions_['include_CoopTask'] ='#include <CoopTask.h>';
    Blockly.Arduino.definitions_['ESP8266_Task'+task] = 'int task_' +task+ '()\n'
                                                      +'{\n'
                                                      +'  ' +branch+ '\n'
                                                      +' for (;;)\n'
                                                      +' {\n'
                                                      ...
                                                      +'  return 0;\n'
                                                      +'}'
                                                      +'CoopTask<>* ESPtask_' +task+ ';\n';
    Blockly.Arduino.setups_['setups_ESP8266_Task_'+task] = 'ESPtask_' +task+ ' = createCoopTask(F("Task_' +task+ '"), task_' +task+ ', 0x240);\n'
                                                        +'  if (!ESPtask_' +task+ ') Serial.println("CoopTask Task_' +task+ ' not created");\n';
    var code = "";
  if(task==1)
  {
    Blockly.Arduino.setups_['setup_serial_9600'] = 'Serial.begin(9600);\n'                                                                                                           
    Blockly.Arduino.loops_['setups_ESP8266_Task_']  = 'runCoopTasks();\n';
  }
    return '' +code+ '';
};
...
//算术运算符
  ...
  Blockly.Arduino.utf8togbk = function() {
    var input_data=Blockly.Arduino.valueToCode(this, 'data', Blockly.Arduino.ORDER_ATOMIC);
    Blockly.Arduino.definitions_['include_QDP_text_code'] = '#include "QDP_text_code.h"';
    Blockly.Arduino.definitions_['var_declare_QDP_text_code'] = 'QDP_text_code text_code;\n';
    var code= "const_cast<char*>(text_code.transform("+input_data+").c_str())";
    return [code, Blockly.Arduino.ORDER_ATOMIC];
  };
...
Blockly.Arduino.qdp_lattice_elf_animation = function() {
 ...
 Blockly.Arduino.qdp_lattice_max7219_setpoint = function() {
    ...
    var code='mx.setPoint(' + ordinate + ', ' + abscissa + ', ' + status + ');\n';
    return code;
};

Blockly.Arduino.qdp_lattice_mx_drawline = function() {
    var origin_abscissa= Blockly.Arduino.valueToCode(this, 'origin_abscissa', Blockly.Arduino.ORDER_ATOMIC);
    var starting_point_ordinate= Blockly.Arduino.valueToCode(this, 'starting_point_ordinate', Blockly.Arduino.ORDER_ATOMIC);
    var end_abscissa= Blockly.Arduino.valueToCode(this, 'end_abscissa', Blockly.Arduino.ORDER_ATOMIC);
    var status= (this.getFieldValue('status'));
    var end_ordinate= Blockly.Arduino.valueToCode(this, 'end_ordinate', Blockly.Arduino.ORDER_ATOMIC);
    var code='mx.drawLine(' + starting_point_ordinate + ',' + origin_abscissa + ',' + end_ordinate+ ',' + end_abscissa + ',' + status + ');\n';
    return code;
};
...
"新港":"101340904"
  ...
  //天气GET
  Blockly.Arduino.qdpWeatherGet = function() {
    var data = Blockly.Arduino.valueToCode(this, 'data',Blockly.Arduino.ORDER_ATOMIC);
    data = data.replace(/\"/g,'');
    var CityCode = WeatherCity[data]; 
    Blockly.Arduino.definitions_['define_QDP_ESP32_Weather'] = '#include "QDP_ESP32_Weather.h"';  
    Blockly.Arduino.definitions_['define_Weather'] = 'QDP_ESP32_Weather Weather;';
    if(CityCode){
  ...
  //获取当天天气
  Blockly.Arduino.qdpWeatherGetToday = function() {
    var type=this.getFieldValue('type');
  ...
  //获取预报天气
  Blockly.Arduino.qdpWeatherGetForecast = function() {
    var type=this.getFieldValue('type');
