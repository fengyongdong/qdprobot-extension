...
function addMsg (Blockly) {
    Object.assign(Blockly.ScratchMsgs.locales.en, {
		...
		QH_ANGLE:'Angle',
		QH_VALUE:'Value',
		QH_Soilmoisture:'Soil rainwater moisture port %1',
		QH_dht11:'Temperature and humidity sensor Port %1 parameter %2',
		QH_Temperature:'Temperature',
		QH_Humidity:'Humidity',
		QH_yssb_init:'Enable color recognition Time delay %1 MS Photosensitive gain %2  value  %3 I2C Address 0x29',
		QH_noPrint:'No Print',
		QH_Print:'Print',
		...
		QH_BT_button:'Bluetooth key P5(R0-L1) %1',
		QH_BT_variable:'Bluetooth variable P5(R0-L1) %1',
		QH_BT_print:'Bluetooth send variable P5(R0-L1) variable 1 %1 variable 2 %2 variable 3 %3 variable 4 %4 variable 5 %5',
		qdp_BT_print_string:'Bluetooth send string P5(R0-L1) variable %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['zh-cn'], {
		...
		QH_ANGLE:'角度',
		QH_VALUE:'值',
		QH_Soilmoisture:'土壤雨水湿度 端口 %1',
		QH_dht11:'温湿度传感器 端口 %1 参数 %2',
		QH_Temperature:'温度',
		QH_Humidity:'湿度',
		QH_yssb_init:'初始化颜色识别 延时 %1 MS 光敏增益 %2 倍 值 %3 I2C地址0x29',
		QH_noPrint:'不打印',
		QH_Print:'打印',
		QH_yssb_get:'获取颜色值 %1',
		...
		QH_relay:'继电器 端口 %1 左/右 %2 状态 %3',
		QH_read_relay:'读取 继电器 端口 %1 左/右 %2 ',
		...
		QH_BT_button:'蓝牙按钮 P5(R0-L1) %1',
		QH_BT_variable:'蓝牙变量 P5(R0-L1) %1',
		QH_BT_print:'蓝牙发送变量 P5(R0-L1) 变量1 %1 变量2 %2 变量3 %3 变量4 %4 变量5 %5',
		qdp_BT_print_string:'蓝牙发送字符串 P5(R0-L1) 变量 %1',
	...
	Object.assign(Blockly.ScratchMsgs.locales["zh-tw"], {
        ...
        qdp_chaoshengboI2C:'QH 超聲波測距(IIC)',
        qdp_chaoshengboSerial:'QH 超聲波測距 %1 端口 %2',
        QH_LINE_FOLLOWER:'巡線 端口 %1 左路 %2 右路 %3',
        QH_LIGHTSENSOR:'光線感測器 端口 %1',
        QH_SOUND:'聲音感測器 端口 %1',
        QH_POTENTIOMETER:'電位感測器 端口 %1 左右 %2',
        QH_JOYSTICK_INITIALIZATION:'遙杆初始化 端口 %1',
        QH_GET_THE_JOYSTICK_VALUE:'獲取搖杆參數 %1',
        QH_ANGLE:'角度',
        QH_VALUE:'值',
        QH_Soilmoisture:'土壤雨水濕度 端口 %1',
        QH_dht11:'溫濕度感測器 端口 %1 參數 %2',
        QH_Temperature:'溫度',
        QH_Humidity:'濕度',
        QH_yssb_init:'初始化顏色識別 延時 %1 MS 光敏增益 %2 倍 值 %3 I2C地址0x29',
        QH_noPrint:'不列印',
        QH_Print:'列印',
        QH_yssb_get:'獲取顏色值 %1',
        QH_yssb_compare:'顏色 如果 %1 = %2 偏差 ± %3',
        ...
        QH_ledlight_PWM:'LED 端口 %1 左/右 %2 值(0~255) %3',
        QH_relay:'繼電器 端口 %1 左/右 %2 狀態 %3',
        QH_read_relay:'讀取 繼電器 端口 %1 左/右 %2 ',
        ...
        QH_code_motor:'編碼電機 端口 %1 可中斷？ %2 脈衝數 %3 速度（-255~255）%4 減速脈衝數 %5 減速速度 %6',
        QH_code_motor_read:'編碼電機狀態 端口 %1 狀態 %2',
        QH_servomotorstate1:'運行中 = 1',
        QH_servomotorstate2:'完成 = 0',
        ...
        QH_servomotorPWM_set180:'舵機板180° 板號 %1 [參數設置] PWM下限值 範圍(1-4095) %2 PWM 上限值 範圍(2-4096) %3',
        QH_servomotorPWM:'舵機板180° 板號 %1 舵機號(0~15) %2 角度 %3 ',
        QH_servomotorPWM_set360:'舵機板360° 板號 %1 [參數設置] PWM停止值 %2 PWM 正轉下限值  %3 PWM 正轉上限值  %4 PWM 反轉下限值  %5 PWM 反轉上限值  %6 ',
        QH_servomotorPWM360:'舵機板360° 板號 %1 方向 %2 舵機號(0-15)  %3 速度(0-10) %4',
        QH_Voice:'語音模組 端口 %1 播放 %2 延時 %3 ',
        QH_VoicePlayValue:'語音模組 端口 %1 播放數字值 %2',
        QH_ASR_SendData:'發送到齊護語音識別 端口 %1 指令 %2',
        QH_ASR_ReceiveData:'齊護語音識別 開啟 端口 %1',
        QH_ASR_CompareData:'齊護語音識別到 端口 %1 指令 %2',
        QH_QF_hc:'語音合成 端口 %1 發音人 %2 中斷 %3 音量(0-11) %4 語速(0-11) %5 語調(0-11) %6 內容 %7',
        QH_QF_sound:'播放提示音 端口 %1 類型 %2 編號(01~25) %3',
        QH_QF_stophc:'停止合成 端口 %1 ',
        QH_QF_startstopsb:'開啟語音識別 端口 %1 播報識別 %2 ',
        QH_Sayresult:'播報識別結果',
        QH_NoSayresult:'不播報識別結果',
        QH_QF_sbjg:'識別結果 端口 %1 識別到 %2',
        ...
        QH_BT_START:'藍牙數據刷新 P5(R0-L1)',
        QH_BT_button:'藍牙按鈕 P5(R0-L1) %1',
        QH_BT_variable:'藍牙變數 P5(R0-L1) %1',
        QH_BT_print:'藍牙發送變數 P5(R0-L1) 變數1 %1 變數2 %2 變數3 %3 變數4 %4 變數5 %5',
        qdp_BT_print_string:'藍牙發送字串 P5(R0-L1) 變數 %1',
        QH_serial_change:'軟串口定義到 端口 %1',
        QH_serial_jieshouzhi:'串口接收數據比較 端口 %1 如果數據= %2',
        QH_serial_fasong:'串口發送 端口 %1 模式 %2 內容 %3',
        QH_SERIAL_WRITE:'原始輸出',
        QH_SERIAL_PRINT:'列印',
        QH_SERIAL_PRINTLN:'列印(自動換行)',
        QH_serial_jieshou:'串口接收 端口 %1 返回字串',
        QH_serial_suju:'串口有數據可讀 端口 %1',
        QH_MP3_bofangx:'播放指定 端口 %1 音量(0-30) %2 曲目 %3',
        QH_MP3_yingliang:'音量調節 端口 %1 音量(0-30) %2',
        QH_MP3_loopplay:'迴圈播放 端口 %1 音量(0-30) %2 曲目 %3',
        QH_MP3_startpause:'播放/暫停 端口 %1 模式 %2',
        QH_START:'播放',
        QH_PAUSE:'暫停',
        QH_MP3_previous_next:'上一首/下一首 端口 %1 模式 %2',
        QH_PREVIOUS:'上一首',
        ...
        QH_play13:'13老虎',
        QH_play14:'14雞',
        QH_ESPuno_define_mp3_directory:'定義MP3 SD卡檔目錄 %1 ',
        QH_ESPuno_mp3_designated_play:'模式 %1 端口 %2 音量(0-30) %3 曲目 %4',
        QH_BOFANGX:'播放指定',
        QH_LOOPPLAY:'迴圈播放',
        QH_display:'數碼管 端口 %1 小數位 %2 數字 %3',
        QH_displayoff:'關閉數碼管 端口 %1',
        QH_display_samll_refresh_display:'彩屏刷新顯示 %1',
        QH_display_samll_HV:'彩屏方向 端口 %1 方向 %2',
        QH_display_samll_HV1:'橫屏0度',
        QH_display_samll_HV0:'豎屏90度',
        QH_display_samll_HV2:'橫屏180度',
        QH_display_samll_HV3:'豎屏270度',
        QH_display_samll_BL:'彩屏亮度 端口 %1 亮度(0-255) %2',
        QH_display_samll_clr:'顏色 端口 %1 模式 %2 顏色(0-63) %3',
        QH_display_samll_clr1:'刷屏',
        QH_display_samll_clr2:'背景',
        QH_display_samll_flash_pic:'圖片顯示 端口 %1 橫/豎 %2 模式 %3 圖片 %4',
        QH_display_samll_HV10:'橫屏',
        QH_display_samll_HV11:'豎屏',
        QH_display_samll_pic0:'正常',
        QH_display_samll_pic1:'透明',
        QH_display_samll_pic:'圖片顯示 %1 模式 %2 地址 %3 起點 X %4 Y %5 寬 高 W %6 H %7',
        QH_display_samll_PS:'畫點 端口 %1 X %2 Y %3 顏色(0-63) %4',
        QH_display_samll_PL:'畫線/框 端口 %1 模式 %2 起點 X %3 Y %4 終點 X %5 Y %6 顏色(0-63) %7',
        QH_display_samll_pl1:'畫線',
        QH_display_samll_pl2:'空心框',
        QH_display_samll_pl3:'實心框',
        QH_display_samll_CIR:'畫圓 端口 %1 樣式 %2 圓心 X %3 Y %4 半徑 R %5 顏色(0-63) %6',
        QH_displaysolidround:'實心圓',
        QH_displayhollowround:'空心圓',
        QH_display_samll_DC:'文本顯示 端口 %1 字體 %2 顏色(0-63) %3 起點 X %4 Y %5 內容 %6',
        QH_display_samll_CN:'文本 端口 %1 字型大小 %2 顏色(0-63) %3 起點 X %4 Y %5 內容 %6',
        QH_display_samll_SBCDC:'帶底色文本 端口 %1 字型大小 %2 底色(0-63) %3 顏色(0-63) %4 起點 X %5 Y %6 內容 %7',
        QH_display_samll_order:'自定義指令 端口 %1 內容 %2 ',
        QH_display_samll_btl:'串列傳輸速率 端口 %1 BPS %2',
        ...
        qdp_display_START:' %1 啟用接收屏數據 P5(R0-L1)',
        qdp_display_button:'屏按鈕 P5(R0-L1)= %1',
        qdp_display_variable:'屏變數 P5(R0-L1) %1',
        qdp_display_print:'發送變數到屏 P5(R0-L1)V %1 值 %2',
        qdp_zkpdisplay_sleep:'屏睡眠 端口 P5 %1',
        QH_displaysleep1:'睡眠',
        QH_displaysleep0:'喚醒',
        ...
        QH_DISPLAY_MATRIX_ROTATE:'旋轉',
        QH_MIRROR:'鏡像',
        oled_init:'初始化OLED %1 名稱 %2 旋轉角度 %3 SCL %4 SDA %5 設備地址 %6',
        oled_page:'%1 OLED %2 刷新頁面',
        oled_showBitmap:'OLED %1 顯示圖像 起點 X %2 Y %3 寬度 %4 高度 %5 圖像名稱 %6',
        tool_modulus:'點陣格式 %1 取模方式 %2 取模走向 %3 字體 %4 字型大小 %5 px 寬 %6 px 高 %7 px 內容 %8',
        tool_modulus_show:'圖像名稱 %1 [%2] 保存到 flash %3 %4',
        oled_clear:'OLED %1 清屏 ',
        u8g2_setContrast:'OLED %1 背光亮度 %2',
        oled_face:'OLED %1 顯示圖像 起點 X %2 Y %3 內置圖示 %4',
        oled_drawPixel:'OLED %1 畫點 起點 X %2 Y %3 ',
        oled_drawLine:'OLED %1 畫線 起點 X %2 Y %3 終點 X %4 Y %5',
        oled_draw_Str_Line:'OLED %1 畫直線 起點 X %2 Y %3 長度 X %4 模式 %5',
        QH_OLED_HOR:'水準',
        QH_OLED_VER:'垂直',
        oled_drawFrame:'OLED %1 畫矩形 模式 %2 起點 X %3 Y %4 寬  %5 高 %6',
        oled_drawRFrame:'OLED %1 畫圓角矩形 模式 %2 起點 X %3 Y %4 寬  %5 高 %6 半徑 %7',
        oled_drawCircle:'OLED %1 畫圓 模式 %2 圓心 X %3 Y %4 半徑  %5 類型 %6',
        QH_OLED_WHOLE_CICILE:'整圓',
        QH_OLED_UP_R:'右上',
        QH_OLED_UP_L:'左上',
        QH_OLED_LOW_R:'右下',
        QH_OLED_LOW_L:'左下',
        oled_drawEllipse:'OLED %1 畫橢圓 模式 %2 圓心 X %3 Y %4 半徑 X %5 Y %6 類型 %7',
        QH_OLED_HOLLOW:'空心',
        QH_OLED_SOLID:'實心',
        oled_drawTriangle:'OLED %1 畫三角形 A點 X %2 Y %3 B點 X %4 Y %5 C點 X %6 Y %7',
        ...
        COOPERATIVESCHEDULER_SETUP: '多任務調度器 %1 setup',
        COOPERATIVESCHEDULER_SLEEP: '多任務調度器延時 %1 ms',
        QH_EQU:'等於(==)',
        QH_NEQ:'不等於(!=)',
        QH_GTR:'大於(>)',
        QH_LSS:'小於(<)',
