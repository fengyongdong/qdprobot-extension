const QDPRobotTeach = formatMessage => ({
    name: 'QDP',                //显示在扩展选择界面的名字
    extensionId: 'QDPRobotTeach',         //扩展的唯一ID
    ...
    description: formatMessage({
        id: 'QDPRobotTeach.description',
        default: 'QDP robot',
        description: 'QDPRobotTeach.description'
    }),                           //显示在扩展选择界面图片下方扩展介绍内容
    featured: true,
