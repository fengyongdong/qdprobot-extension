...
function addGenerator (Blockly) {
  ...
  "FFE5":"A3A4"
    ...
    Blockly.Arduino.dht_init = function (block) {
     ...
     //小彩屏初始化
    Blockly.Arduino.QDP_esp32_display_samll_init = function() {
        var PIN = this.getFieldValue('PIN');
        var Serial = this.getFieldValue('Serial');
        var btl = this.getFieldValue('btl');
        Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
        Blockly.Arduino.definitions_['var_declare_Esp32_HardwareSerial'+Serial] = 'HardwareSerial  myHardwareSerial'+Serial+'(Serial'+Serial+');'; 
        Blockly.Arduino.setups_['setup_qdprobot_eps32_serial'+Serial] = 'myHardwareSerial'+Serial+'.begin('+btl+',SERIAL_8N1,P'+PIN+'R,P'+PIN+'L);';
     ...
     //彩屏刷新显示
    Blockly.Arduino.QDP_esp32_display_samll_refresh_display = function() {
      var Serial = this.getFieldValue('Serial');
      var branch = Blockly.Arduino.statementToCode(this, 'DO');
      branch = branch.replace(/(^\s*)|(\s*$)/g, "");//去除两端空格
      var code = branch+'\nmyHardwareSerial'+Serial+'.println("");\n'; 
      return code;
     };

     //小彩屏横竖屏设置
    Blockly.Arduino.QDP_esp32_display_samll_HV = function() {
      var Serial = this.getFieldValue('Serial');
      var dropdown_pin3 = this.getFieldValue('pin');
      
      var code = 'myHardwareSerial'+Serial+'.print("DIR('+dropdown_pin3+');");\n';
      
      return code;
     };
      //屏亮度设置
     Blockly.Arduino.QDP_esp32_display_samll_BL = function() {
      var Serial = this.getFieldValue('Serial');
      var num = Blockly.Arduino.valueToCode(this, 'QDP_display_samll_bl_1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;

      var code = 'myHardwareSerial'+Serial+'.print(String("BL(")+String('+num+')+String(");"));\n';

    return code;
     };

     //小彩屏颜色刷屏
     Blockly.Arduino.QDP_esp32_display_samll_clr = function() {
      var Serial = this.getFieldValue('Serial');
      var dropdown_pin3 = this.getFieldValue('pin');

      var num = Blockly.Arduino.valueToCode(this, 'QDP_display_samll_clr_1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
      
      var code = 'myHardwareSerial'+Serial+'.print(String("'+dropdown_pin3+'(")+String('+num+')+String(");"));\n';
     ...
     Blockly.Arduino.QDP_esp32_display_samll_pic = function() {
      ...
      var code = 'myHardwareSerial'+Serial+'.print(String("FSIMG(")+String('+num1+')+String(",")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(",")+String('+num5+')+String(",")+String('+dropdown_pin3+')+String(");"));\n';

      return code;
     };

     //彩屏定义图像名称和数据
    Blockly.Arduino.QDP_esp32_customize_display_define_bitmap_data = function() {
      var image_name = Blockly.Arduino.valueToCode(this, 'image_name',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
      image_name = image_name.replace(/\"/g,'');
      var data = Blockly.Arduino.valueToCode(this, 'data',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
      data = data.replace(/\"/g,'');
      Blockly.Arduino.definitions_['genius'+image_name] = 'PROGMEM const unsigned char ' + image_name + '[] = {' + data + '};\n';
      return '';
    };

    //自定义取模显示
     Blockly.Arduino.QDP_esp32_customize_display = function() {
      var Serial = this.getFieldValue('Serial');
      var colour= Blockly.Arduino.valueToCode(this, 'colour', Blockly.Arduino.ORDER_ATOMIC);
      var data= Blockly.Arduino.valueToCode(this, 'data', Blockly.Arduino.ORDER_ATOMIC);
      data = data.replace(/\"/g,'');
      var X = Blockly.Arduino.valueToCode(this, 'QDP_display_samll_pic_X',Blockly.Arduino.ORDER_ATOMIC);
      var Y = Blockly.Arduino.valueToCode(this, 'QDP_display_samll_pic_Y',Blockly.Arduino.ORDER_ATOMIC);
      var W = Blockly.Arduino.valueToCode(this, 'QDP_display_samll_pic_W',Blockly.Arduino.ORDER_ATOMIC);
      var H = Blockly.Arduino.valueToCode(this, 'QDP_display_samll_pic_H',Blockly.Arduino.ORDER_ATOMIC);
      Blockly.Arduino.definitions_['QDP_customize_display'] ='void QDP_customize_display(int16_t x, int16_t y, const uint8_t *bitmap, int16_t w, int16_t h, uint16_t color)\n{\n  int32_t i, j, byteWidth = (w + 7) / 8;\n  for (j = 0; j < h; j++) {\n    for (i = 0; i < w; i++ ) {\n      if (pgm_read_byte(bitmap + j * byteWidth + i / 8) & (1 << (i & 7))) {\n        myHardwareSerial'+Serial+'.print(String("PS(") + String(x + i) + String(",") + String(y + j) + String(",") + String(color) + String(");"));\n        myHardwareSerial'+Serial+'.println("");\n        delay(4);\n      }\n    }\n  }\n}\n';
      var code = 'QDP_customize_display(' + X + ', ' + Y + ', ' + data + ', ' + W + ', ' + H + ', ' + colour + ');\n';
      return code;
     };

     //小彩屏画点指令
     Blockly.Arduino.QDP_esp32_display_samll_PS = function() {
      var Serial = this.getFieldValue('Serial');
      ...
      var code = 'myHardwareSerial'+Serial+'.print(String("PS(")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(");"));\n';

      return code;
     };

     //小彩屏画线框
     Blockly.Arduino.QDP_esp32_display_samll_PL = function() {
      var Serial = this.getFieldValue('Serial');
      var dropdown_pin3 = this.getFieldValue('pin');
      ...
      var code = 'myHardwareSerial'+Serial+'.print(String("'+dropdown_pin3+'(")+String('+num1+')+String(",")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(",")+String('+num5+')+String(");"));\n';

      return code;
     };

     //小彩屏画圆
     Blockly.Arduino.QDP_esp32_display_samll_CIR = function() {
      var Serial = this.getFieldValue('Serial');
      var dropdown_pin3 = this.getFieldValue('pin');
      ...
      var code = 'myHardwareSerial'+Serial+'.print(String("'+dropdown_pin3+'(")+String('+num1+')+String(",")+String('+num2+')+String(",")+String('+num3+')+String(",")+String('+num4+')+String(");"));\n';

      return code;
     };

      //显示文本
     Blockly.Arduino.QDP_esp32_display_samll_DC = function() {
      var Serial = this.getFieldValue('Serial');
      var dropdown_pin3 = this.getFieldValue('pin');
    ...
    //   //显示文本
    //  Blockly.Arduino.QDP_esp32_display_samll_CN = function() {
    ...
    //  //显示文本
    //  Blockly.Arduino.QDP_esp32_display_samll_CN_1 = function() {
    //   var Serial = this.getFieldValue('Serial');
    //   var dropdown_pin3 = this.getFieldValue('pin');
    //   var num1 = Blockly.Arduino.valueToCode(this, 'QDP_display_samll_dc_colou',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    //   var num2 = Blockly.Arduino.valueToCode(this, 'QDP_display_samll_dc_X',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    ...
    //   var code = 'myHardwareSerial'+Serial+'.print(String("DC'+dropdown_pin3+'(")+String('+num2+')+String(",")+String('+num3+')+String(","));\ntransform_'+Serial+'('+num4+');\nmyHardwareSerial'+Serial+'.print(String(",")+String('+num1+')+String(");"));\n';

    //   return code;
    // };

    //显示带底色文本
     Blockly.Arduino.QDP_esp32_display_samll_SBCDC = function() {
      var Serial = this.getFieldValue('Serial');
      var dropdown_pin3 = this.getFieldValue('pin');
     ...
     //自定指令
     Blockly.Arduino.QDP_esp32_display_samll_order = function() {
      var Serial = this.getFieldValue('Serial');
      var text = Blockly.Arduino.valueToCode(this, 'text',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;

     
      var code = 'myHardwareSerial'+Serial+'.print('+text+'+String(");"));\n';

      return code;
     };

     //小彩屏波特率设置
     Blockly.Arduino.QDP_esp32_display_samll_btl = function() {
      var Serial = this.getFieldValue('Serial');
      var dropdown_pin3 = this.getFieldValue('pin');


      var code = 'myHardwareSerial'+Serial+'.print("BPS('+dropdown_pin3+');");\n';

      return code;
     };

     //ESP32触控
    Blockly.Arduino.QDP_inout_esp32_touchRead = function () {
    ...
    //ESP32触控事件
  Blockly.Arduino.QDP_inout_esp32_touchEvents = function () {
    var touch_pin = this.getFieldValue('touch_pin');
    var Model = this.getFieldValue('Model');

    Blockly.Arduino.definitions_['include_NoiselessTouchESP32'] = '#include <NoiselessTouchESP32.h>';
    Blockly.Arduino.definitions_['var_declare_NoiselessTouchESP32'+touch_pin] = 'NoiselessTouchESP32 touchsensor_'+touch_pin+'('+touch_pin+', 10, 40);';
    var code = 'touchsensor_'+touch_pin+'.'+Model +'()';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
  };
  ...
  Blockly.Arduino.qdp_esp32_buttonl = function() {
    ...
    //左右按钮
  Blockly.Arduino.qdp_esp32_buttonx = function() {
  ...
  //启用多功能按钮
  Blockly.Arduino.qdp_esp32_buttonfuction1 = function() {
    var dropdown_pin = this.getFieldValue('PIN');
    ...
    //多功能钮
  Blockly.Arduino.qdp_esp32_button1 = function() {
    var dropdown_pin = this.getFieldValue('PIN');
  ...
  //超声波
  Blockly.Arduino.qdp_esp32_chaoshengbo = function() {
    var dropdown_pin = this.getFieldValue('PIN');
    var dropdown_pin2 = this.getFieldValue('PIN2');
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    Blockly.Arduino.definitions_['define_HCSR'] = '#include <QDPHCSR04Esp32.h>';
    Blockly.Arduino.definitions_['var_declare_qdprobot_chaoshengbo'+dropdown_pin] = 'UltraSonicDistanceSensor distanceSensor_'+dropdown_pin+'(P'+dropdown_pin+'L,P'+dropdown_pin+'R);\n';
    var code = 'distanceSensor_'+dropdown_pin+'.measureDistance'+dropdown_pin2+'()';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
  };

      //超声波I2C
Blockly.Arduino.qdp_esp32_chaoshengboI2C = function() {
...
'}\n'
  ...
  Blockly.Arduino.qdp_esp32_sound = function() {
   ...
   //电位器
  Blockly.Arduino.qdp_esp32_potentiometer = function() {
    var dropdown_pin = this.getFieldValue('PIN');
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    var code = 'analogRead('+dropdown_pin+')';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
    ...
    //土壤
  Blockly.Arduino.qdp_esp32_Soilmoisture = function() {
    var dropdown_pin = this.getFieldValue('PIN');
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    var code = 'analogRead('+dropdown_pin+')';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
    ...
    //DH11温湿度
  Blockly.Arduino.qdp_esp32_dht11 = function () {
    var dropdown_pin = this.getFieldValue('PIN');
    var what = this.getFieldValue('WHAT');
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    Blockly.Arduino.definitions_['define_dht'] = '#include <esp_dht.h>';
    Blockly.Arduino.definitions_['define_dht_p'] = 'DHT11 dht11_'+dropdown_pin+'('+dropdown_pin+');\n uint8 value[5];\nint getDHT11_'+dropdown_pin+'(uint8_t mode) {\n dht11_'+dropdown_pin+'.Read_Value(value);\nif (mode == 0) {\nreturn value[2];\n} else {\n return value[0];\n}\n}\n';
   
    var code='getDHT11_'+dropdown_pin+'('+what+')';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
  };

  //颜色传感器启用块
  Blockly.Arduino.qdp_esp32_yscgq = function() {
  ...
  //传感器-MPU6050-更新数据
  Blockly.Arduino.QDP_ESP32_MPU6050_update = function() {
    var consoleModel = this.getFieldValue('consoleModel');
    Blockly.Arduino.definitions_['includeMPU6050_tockn'] = '#include <MPU6050_tockn.h>';
    Blockly.Arduino.definitions_['include_Wire'] = '#include <Wire.h>';
    Blockly.Arduino.definitions_['var_declare_MPU6050'] = 'MPU6050 mpu(Wire);';
    Blockly.Arduino.setups_['setup_Wire_begin'] = 'Wire.begin();';
    Blockly.Arduino.setups_['setup_mpu_begin'] = 'mpu.begin();';
    if(consoleModel == '1')
    Blockly.Arduino.setups_['setup_mpu_calcGyroOffsets'] = 'mpu.calcGyroOffsets(true);';
    else
    Blockly.Arduino.setups_['setup_mpu_calcGyroOffsets'] = 'mpu.calcGyroOffsets(false);';
    var code = 'mpu.update();\n';
    return code;
  };

  //传感器-MPU6050-获取数据
  Blockly.Arduino.QDP_ESP32_MPU6050_GETDATA = function() {
  ...
  //ESP32霍尔值
  Blockly.Arduino.QDP_ESP32_hallRead = function () {
  ...
  Blockly.Arduino.qdp_esp32_ledlight = function() {
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    var dropdown_pin = this.getFieldValue('PIN');
  ...
  //读取LED状态
  Blockly.Arduino.qdp_esp32_read_ledlight = function() {
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    var dropdown_pin = this.getFieldValue('PIN');
    Blockly.Arduino.setups_['setup_output33_'+dropdown_pin] = 'pinMode('+dropdown_pin+', OUTPUT);';
    var code = 'digitalRead('+dropdown_pin+')'
  ...
  //LED2
  Blockly.Arduino.qdp_esp32_ledlight3 = function() {
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    Blockly.Arduino.definitions_['define_esp32_analogWrite'] = '#include <analogWrite.h>';
    var dropdown_pin = this.getFieldValue('PIN');
  ...
  //继电器板
  Blockly.Arduino.qdp_esp32_relay = function() {
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    var dropdown_pin = this.getFieldValue('PIN');
    var dropdown_stat = Blockly.Arduino.valueToCode(this, 'STAT', Blockly.Arduino.ORDER_ATOMIC);  
    Blockly.Arduino.setups_['setup_output33_'+dropdown_pin] = 'pinMode('+dropdown_pin+', OUTPUT);';
  ...
  //读继电器板状态
  Blockly.Arduino.qdp_esp32_read_relay = function() {
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    var dropdown_pin = this.getFieldValue('PIN');
    Blockly.Arduino.setups_['setup_output33_'+dropdown_pin] = 'pinMode('+dropdown_pin+', OUTPUT);';
    var code = 'digitalRead('+dropdown_pin+')'
  ...
  Blockly.Arduino.qdp_esp32_buzzer3=function(){
    var dropdown_pin = this.getFieldValue('PIN'); 
    var dropdown_pin2 = Blockly.Arduino.valueToCode(this, 'PIN2', Blockly.Arduino.ORDER_ATOMIC);
    var CHANNEL = this.getFieldValue("CHANNEL");
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    Blockly.Arduino.definitions_['define_ESP32_tone'] = '#include <Tone32.h>';
    var dur = Blockly.Arduino.valueToCode(this, 'DURATION',Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
    var code='tone('+dropdown_pin+','+dropdown_pin2+','+dur+','+CHANNEL+');\nnoTone('+dropdown_pin+','+CHANNEL+');\n';
    return code; 
  };
  ...
  //蜂鸣器音乐
  Blockly.Arduino.qdp_esp32_buzzer_music=function(){
    var dropdown_pin = this.getFieldValue('PIN'); 
    var dropdown_pin2 = this.getFieldValue('PIN2');
    var CHANNEL = this.getFieldValue("CHANNEL");
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    ...
    var code='buzzer_music('+dropdown_pin+','+dropdown_pin2+','+CHANNEL+');\n';
    return code; 
  ...
  //舵机角度
  Blockly.Arduino.qdp_esp32_servomotorread = function() {
    var dropdown_pin = this.getFieldValue('pin');
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    Blockly.Arduino.definitions_['define_ESP32_Servo'] = '#include <ESP32_Servo.h>';
    Blockly.Arduino.definitions_['var_declare_qdprobot_motor31'+dropdown_pin] = 'Servo QDPservo_'+dropdown_pin+';\n';
  ...
  //舵机板设置参数180
    Blockly.Arduino.qdp_esp32_servomotorPWM_set180 = function() {
        var dropdown_pin = this.getFieldValue('pin');
    ...
    //舵机板180
    Blockly.Arduino.qdp_esp32_servomotorPWM = function() {
        var dropdown_pin = this.getFieldValue('pin');
        var num1 = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) || '0';
        var num2 = Blockly.Arduino.valueToCode(this, 'num2',Blockly.Arduino.ORDER_ATOMIC) || '0';
    ...
    //舵机板360度设置参数
    Blockly.Arduino.qdp_esp32_servomotorPWM_set360 = function() {
        var dropdown_pin = this.getFieldValue('pin');
    ...
    //舵机板360度
    Blockly.Arduino.qdp_esp32_servomotorPWM360 = function() {
        var dropdown_pin = this.getFieldValue('pin');
        var dropdown_pin3 = this.getFieldValue('pin3');
        var num1 = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) || '0';
        var num2 = Blockly.Arduino.valueToCode(this, 'num2',Blockly.Arduino.ORDER_ATOMIC) || '0';
   ...
   //语音识别发送数据
  Blockly.Arduino.QDP32_ASR_SendData = function() {
    ...
    Blockly.Arduino.definitions_['define_SoftwareSerial'] = '#include <Esp32SoftwareSerial.h>';
    Blockly.Arduino.definitions_['var_declare_MyASR'+PIN] = 'QDPASR MyASR'+PIN+';';
    Blockly.Arduino.definitions_['define_Esp32_SoftwareSerial'+PIN] = 'Esp32SoftwareSerial  swP'+PIN+';\n'; 
    Blockly.Arduino.setups_['setup_qdprobot_eps32_serial'+PIN] ='swP'+PIN+'.begin(9600, SWSERIAL_8N1, P'+PIN+'L, P'+PIN+'R, false, 256);';
    Blockly.Arduino.setups_['setup_qdprobot_serial3'+PIN] = 'MyASR'+PIN+'.begin(swP'+PIN+');';
    var code = 'MyASR'+PIN+'.SendData(\"'+keyword+'\");\n';
    return code;
  };

  //语音识别接收
  Blockly.Arduino.QDP32_ASR_ReceiveData = function() {
    var PIN = this.getFieldValue('pin1');
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    Blockly.Arduino.definitions_['include_QDPASR'] = '#include <QDPASR.h>';
    Blockly.Arduino.definitions_['define_SoftwareSerial'] = '#include <Esp32SoftwareSerial.h>';
    ...
    Blockly.Arduino.setups_['setup_qdprobot_eps32_serial'+PIN] ='swP'+PIN+'.begin(9600, SWSERIAL_8N1, P'+PIN+'L, P'+PIN+'R, false, 256);';
    Blockly.Arduino.setups_['setup_qdprobot_serial3'+PIN] = 'MyASR'+PIN+'.begin(swP'+PIN+');';
    var code ='MyASR'+PIN+'.ReceiveData();\n';
    return code;
  };

  //语音识别对比数据
  Blockly.Arduino.QDP32_ASR_CompareData = function() {
    var PIN = this.getFieldValue('pin1');
    var keyword = this.getFieldValue('keyword');
    var code = 'MyASR'+PIN+'.CompareData(\"'+keyword+'\")';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
  };

  //AI语音识别初始化
  Blockly.Arduino.speech_recognition_initialization = function() {
    var port= this.getFieldValue('port');
    var auth= Blockly.Arduino.valueToCode(this, 'auth', Blockly.Arduino.ORDER_ATOMIC);
    Blockly.Arduino.definitions_["include_QDProbotAI"] = '#include <QDProbotAI.h>';
    Blockly.Arduino.definitions_['var_declare_speech_recognition_initialization'] ='QDProbotAI rest;';
    Blockly.Arduino.setups_["setup_speech_recognition_initialization"] ='rest.Speech_recognition_initialization(' +port+ '' +auth+ ');';
    var code='';
    return code;
  };

  //AI语音识别返回结果
  Blockly.Arduino.speech_recognition = function() {
    var Language= this.getFieldValue('Language');
    var code = 'rest.Speech_Recognition(' +Language+ ')';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
  };

  //AI语音识别时间控制
  Blockly.Arduino.identification_switch = function() {
    var code='rest.Identification_switch();\n';
    return code;
  };

  //QF合成初始化
  Blockly.Arduino.qdp_esp32_QF_hc_init = function() {
    var PIN = this.getFieldValue('PIN');
    var Serial = this.getFieldValue('Serial');
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    ...
    Blockly.Arduino.definitions_['var_declare_Esp32_HardwareSerial'+Serial] = 'HardwareSerial  myHardwareSerial'+Serial+'(Serial'+Serial+');\n'; 
    Blockly.Arduino.setups_['setup_qdprobot_eps32_serial'+Serial] = 'myHardwareSerial'+Serial+'.begin(9600,SERIAL_8N1,P'+PIN+'L,P'+PIN+'R);\ndelay(20);\n';

    Blockly.Arduino.setups_['setup_qdprobot_eps32_HC_init'] ='QFYY.begin(myHardwareSerial'+Serial+');';
    var code ='';
    return code;
  };

  // //QF合成
  // Blockly.Arduino.qdp_esp32_QF_hc = function() {
  //   var number = Math.ceil(Math.random() * 100000);  
  ...
  //   Blockly.Arduino.definitions_['var_declare_'+number] = 'char Str_'+number+'[] = {'+text+'};';//定义数组
  ...
  Blockly.Arduino.qdp_esp32_QF_hc_en = function() {
    var dropdown_pin3 = this.getFieldValue('PIN33');
    var dropdown_pin4 = this.getFieldValue('PIN44');
    var num = Blockly.Arduino.valueToCode(this, 'num',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    var num2 = Blockly.Arduino.valueToCode(this, 'num2',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  ...
  //QF停止合成
  Blockly.Arduino.qdp_esp32_QF_stophc = function() {
    var code = 'QFYY.TZHC();\n';
    return code;
  };

  //QF启动识别
  Blockly.Arduino.qdp_esp32_QF_startstopsb = function() {
  ...
  //QF识别结果
  Blockly.Arduino.qdp_esp32_QF_sbjg = function() {
    var number = Math.ceil(Math.random() * 100000);  
  ...
  //QF识别结果2
  Blockly.Arduino.qdp_esp32_QF_sbjg2 = function() {
    var number = Math.ceil(Math.random() * 100000);  
  ...
  //蓝牙接收数据
  Blockly.Arduino.qdp_esp32_BT_START = function() {
    ...
    Blockly.Arduino.definitions_['var_declare_define_AppBtRec'] = 'AppBtRec AppBtRec(SerialBT,'+PRINT+');\n';
    
 
    Blockly.Arduino.setups_['setup_serial_BT'] =  'SerialBT.begin(' + VALUE + ');';
    var code = 'AppBtRec.PortReceive();\n';
    return code;
  };

  //蓝牙按键
  Blockly.Arduino.qdp_esp32_BT_button = function() {
   ...
   //蓝牙变量
  Blockly.Arduino.qdp_esp32_BT_variable = function() {
    var dropdown_pin1 = this.getFieldValue('pin');
  ...
  Blockly.Arduino.qdp_esp32_BT_print = function() {
...
Blockly.Arduino.qdp_esp32_BT_print_string = function() {
  ...
  Blockly.Arduino.qdp_esp32_BT_MASTER_CONNECT = function() {
    ...
    if(type =='1'){
      num = num.replace(/\"/g, "")
      let regex="^[A-Fa-f0-9]+$";
      if(num.match(regex) && num.length == 12){
        num = num.replace(/[\w\s]{2}/g, "0x$&,");
        num = num.substr(0,num.length-1);
        num = num.replace(/^.*$/g, "{$&}");
        Blockly.Arduino.definitions_['var_declare_mac_address'] = 'uint8_t mac_address[6]  = '+num+';\n';
        num = 'mac_address';
        this.setFieldValue('MAC数组', "info");
      }else{
        this.setFieldValue('MAC数组名', "info");
      }
    }
    else{
      this.setFieldValue('蓝牙名称', "info");
    }
    
    
    Blockly.Arduino.definitions_['var_declare_BluetoothSerial'] = '#include "BluetoothSerial.h"\nBluetoothSerial SerialBT;';
    Blockly.Arduino.setups_['setup_serial_BT'] =  'SerialBT.begin("qdprobot-Master", true);';
    var code = 'SerialBT.connect('+num+')';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
  };

  //蓝牙Master是否有数据可读
  Blockly.Arduino.qdp_esp32_BT_MASTER_AVAILABLE = function() {
    Blockly.Arduino.definitions_['var_declare_BluetoothSerial'] = '#include "BluetoothSerial.h"\nBluetoothSerial SerialBT;';
    Blockly.Arduino.setups_['setup_serial_BT'] =  'SerialBT.begin("qdprobot-Master", true);';
  ...
  //蓝牙Master连接状态
    Blockly.Arduino.qdp_esp32_BT_MASTER_CONNECTED = function() {
      var TIMEOUT = Blockly.Arduino.valueToCode(this, 'TIMEOUT',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
      Blockly.Arduino.definitions_['var_declare_BluetoothSerial'] = '#include "BluetoothSerial.h"\nBluetoothSerial SerialBT;';
      Blockly.Arduino.setups_['setup_serial_BT'] =  'SerialBT.begin("qdprobot-Master", true);';
      var code = 'SerialBT.connected('+TIMEOUT+')';
      return [code, Blockly.Arduino.ORDER_ATOMIC];
    };

  //蓝牙Master连接控制
  Blockly.Arduino.qdp_esp32_BT_MASTER_CONNECT_CONTROL = function() {
    var type = this.getFieldValue('TYPE');
    Blockly.Arduino.definitions_['var_declare_BluetoothSerial'] = '#include "BluetoothSerial.h"\nBluetoothSerial SerialBT;';
    Blockly.Arduino.setups_['setup_serial_BT'] =  'SerialBT.begin("qdprobot-Master", true);\n';
    var code = 'SerialBT.'+type+'();\n';
    return code;
  };
  ...
  //串口接收的数据等于
  Blockly.Arduino.qdp_esp32_serial_jieshouzhi = function() {
    var PIN = this.getFieldValue('pin1');
    var num = Blockly.Arduino.valueToCode(this, 'text',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    Blockly.Arduino.definitions_['define_SoftwareSerial'] = '#include <Esp32SoftwareSerial.h>';
    ...
    //+'swP'+PIN+'.listen();\n'
    +'if (swP'+PIN+'.available() > 0) {\n'
    +'  recStr = swP'+PIN+'.readString();\n'
    +'}\n'
   ...
   //串口发送
  Blockly.Arduino.qdp_esp32_serial_fasong = function() {
    var PIN = this.getFieldValue('pin1');
    var num = Blockly.Arduino.valueToCode(this, 'text',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    ...
    Blockly.Arduino.definitions_['define_Esp32_SoftwareSerial'+PIN] = 'Esp32SoftwareSerial  swP'+PIN+';\n'; 
    Blockly.Arduino.setups_['setup_qdprobot_eps32_serial'+PIN] ='swP'+PIN+'.begin(9600, SWSERIAL_8N1, P'+PIN+'L, P'+PIN+'R, false, 256);';
    var code = 'swP'+PIN+'.'+OutputModel+'('+num+');\n'; 
    return code;
  };

  //串口接收
  Blockly.Arduino.qdp_esp32_serial_jieshou = function() {
    var PIN = this.getFieldValue('pin1');
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
    ...
    Blockly.Arduino.definitions_['define_Esp32_SoftwareSerial'+PIN] = 'Esp32SoftwareSerial  swP'+PIN+';\n'; 
    Blockly.Arduino.setups_['setup_qdprobot_eps32_serial'+PIN] ='swP'+PIN+'.begin(9600, SWSERIAL_8N1, P'+PIN+'L, P'+PIN+'R, false, 256);';
    var code = 'swP'+PIN+'.readString()'; 

    return [code, Blockly.Arduino.ORDER_ATOMIC];
   };

   //串口有数据可读
  Blockly.Arduino.qdp_esp32_serial_suju = function() {
    var PIN = this.getFieldValue('pin1');
    Blockly.Arduino.definitions_['define_QDPEsp32Port'] = '#include <QDPEsp32Port.h>';
  ...
  Blockly.Arduino.esp32_BleKeyboard_init = function() {
    ...
    Blockly.Arduino.definitions_['include_BleKeyboard'] = '#include <BleKeyboard.h>';
  ...
  //MP3初始化
  Blockly.Arduino.esp32_Mp3_init = function() {
    var PIN = this.getFieldValue('PIN');
    var Serial = this.getFieldValue('Serial');
    ...
    Blockly.Arduino.definitions_['var_declare_declare_Esp32_HardwareSerial'+Serial] = 'HardwareSerial  myHardwareSerial'+Serial+'(Serial'+Serial+');'; 
    Blockly.Arduino.setups_['setup_qdprobot_eps32_serial'+Serial] = 'myHardwareSerial'+Serial+'.begin(9600,SERIAL_8N1,P'+PIN+'L,P'+PIN+'R);\ndelay(20);\n';
    Blockly.Arduino.setups_['setup_myQDPPlayer_begin'] = 'if (!myQDPPlayer.begin(myHardwareSerial'+Serial+')) {\n   while(true);\n }';
   ...
   //MP3播放
  Blockly.Arduino.qdp_esp32_MP3_bofangx = function() {
    var num = Blockly.Arduino.valueToCode(this, 'num',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    var num2 = Blockly.Arduino.valueToCode(this, 'num2',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  ...
  //MP3音量
  Blockly.Arduino.qdp_esp32_MP3_yingliang = function() {
    var num = Blockly.Arduino.valueToCode(this, 'num',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    var code ='myQDPPlayer.volume('+num+');\n ';
    return code;
  };
  ...
  //MP3重复播放
  Blockly.Arduino.qdp_esp32_MP3_loopplay = function() {
  ...
  //MP3播放暂停
  Blockly.Arduino.qdp_esp32_MP3_startpause = function() {
  ...
  //MP3上一首
  Blockly.Arduino.qdp_esp32_MP3_previous_next = function() {
    var dropdown_pin3 = this.getFieldValue('PIN22');
  ...
  //MP3播放音效
  Blockly.Arduino.qdp_esp32_MP3_play = function() {
    var dropdown_pin3 = this.getFieldValue('pin2');
    var num = Blockly.Arduino.valueToCode(this, 'num',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  ...
  Blockly.Arduino.qdp_ESP32_define_mp3_directory = function() {
      var data = Blockly.Arduino.valueToCode(this, 'data',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
      data = data.replace(/\"/g,'');
  ...
  Blockly.Arduino.qdp_ESP32_mp3_designated_play = function() {
      var mode = this.getFieldValue('mode');
  ...
  //数码管显示 
  Blockly.Arduino.qdp_esp32_display = function() {
    var dropdown_pin = this.getFieldValue('PIN');
    var dropdown_pin2 = this.getFieldValue('PIN2');
    var VALUE = Blockly.Arduino.valueToCode(this, 'VALUE',Blockly.Arduino.ORDER_ATOMIC) || '0';
  ...
  //数码管清屏
  Blockly.Arduino.qdp_esp32_display_clear = function() {
    var dropdown_pin = this.getFieldValue('PIN');
  ...
  //关闭数码管
  Blockly.Arduino.qdp_esp32_displayoff = function() {
  ...
  //esp32OLED
  Blockly.Arduino.esp32_oled_init = function() {
    var PIN = this.getFieldValue('PIN');
  ...
  Blockly.Arduino.esp32_oled_page = function() {
    var branch = Blockly.Arduino.statementToCode(this, 'DO');
  ...
  Blockly.Arduino.esp32_oled_set_EN_Font = function() {
  ...
  Blockly.Arduino.esp32_oled_set_CN_Font = function() {
    var FONT_NAME = this.getFieldValue('FONT_NAME');
    var FONT_SIZE = this.getFieldValue('FONT_SIZE');
  ...
  Blockly.Arduino.esp32_oled_print = function() {
  ...
  Blockly.Arduino.esp32_oled_define_bitmap_data = function() {
  ...
  Blockly.Arduino.esp32_oled_showBitmap = function() {
  ...
  Blockly.Arduino.esp32_oled_drawPixel = function() {
    var pos_x = Blockly.Arduino.valueToCode(this, 'POS_X') || '0';
    var pos_y = Blockly.Arduino.valueToCode(this, 'POS_Y') || '0';
    var code = "";
  ...
  Blockly.Arduino.esp32_oled_drawLine = function() {
    var start_x = Blockly.Arduino.valueToCode(this, 'START_X') || '0';
    var start_y = Blockly.Arduino.valueToCode(this, 'START_Y') || '0';
  ...
  Blockly.Arduino.esp32_oled_draw_Str_Line = function() {
    var start_x = Blockly.Arduino.valueToCode(this, 'START_X') || '0';
    var start_y = Blockly.Arduino.valueToCode(this, 'START_Y') || '0';
  ...
  Blockly.Arduino.esp32_oled_drawFrame = function() {
  ...
  Blockly.Arduino.esp32_oled_drawRFrame = function() {
    var D0_x = Blockly.Arduino.valueToCode(this, 'D0_X') || '0';
    var D0_y = Blockly.Arduino.valueToCode(this, 'D0_Y') || '0';
    var Width = Blockly.Arduino.valueToCode(this, 'WIDTH') || '0';
    var Height = Blockly.Arduino.valueToCode(this, 'HEIGHT') || '0';
    ...
    Blockly.Arduino.esp32_oled_drawCircle = function() {
    var D0_x = Blockly.Arduino.valueToCode(this, 'D0_X') || '0';
    var D0_y = Blockly.Arduino.valueToCode(this, 'D0_Y') || '0';
    var Rauius = Blockly.Arduino.valueToCode(this, 'RADIUS') || '0';
    var type = this.getFieldValue('TYPE');
  ...
  Blockly.Arduino.esp32_oled_drawEllipse = function() {
    var D0_x = Blockly.Arduino.valueToCode(this, 'D0_X') || '0';
    var D0_y = Blockly.Arduino.valueToCode(this, 'D0_Y') || '0';
  ...
  Blockly.Arduino.esp32_oled_drawTriangle = function() {
    var D0_x = Blockly.Arduino.valueToCode(this, 'D0_X') || '0';
    var D0_y = Blockly.Arduino.valueToCode(this, 'D0_Y') || '0';
  ...
  Blockly.Arduino.qdp_esp32_ZKDisplay_init = function() {
    var PIN = this.getFieldValue('PIN');
    ...
    Blockly.Arduino.definitions_['define_SoftwareSerial'] = '#include <Esp32SoftwareSerial.h>';
    Blockly.Arduino.definitions_['define_Esp32_SoftwareSerial'+PIN] = 'Esp32SoftwareSerial  swP'+PIN+';\n'; 
    Blockly.Arduino.definitions_['define_qdprobot_qdpzkp'+PIN] = 'ZKDisplay ZKDisplay(swP'+PIN+');\n';
    Blockly.Arduino.setups_['setup_qdprobot_eps32_serial'+PIN] ='swP'+PIN+'.begin(9600, SWSERIAL_8N1, P'+PIN+'L, P'+PIN+'R, false, 256);';
    var code ='';
    return code;
  };
  ...
  Blockly.Arduino.qdp_esp32_display_START = function() {
  ...
  Blockly.Arduino.qdp_esp32_display_button = function() {
    var num = Blockly.Arduino.valueToCode(this, 'TEXT',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  ...
  //读掌控屏变量
  Blockly.Arduino.qdp_esp32_display_variable = function() {
    var dropdown_pin1 = this.getFieldValue('pin');
  ...
  //发送变量到掌控屏
  Blockly.Arduino.qdp_esp32_display_print = function() {
    var dropdown_pin1 = this.getFieldValue('pin');
    var num1 = Blockly.Arduino.valueToCode(this, 'N1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  ...
  //睡眠控制
  Blockly.Arduino.qdp_esp32_zkpdisplay_sleep = function() {
    var dropdown_pin2 = this.getFieldValue('pin2');
  ...
  //屏蜂鸣器
  Blockly.Arduino.qdp_esp32_zkpdisplay_buzzer = function() {
    var dropdown_pin = this.getFieldValue('pin2');
    var num = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
   ...
   //颜色
  Blockly.Arduino.qdp_esp32_zkpdisplay_color = function() {
    var dropdown_pin = this.getFieldValue('pin1');
    var code = ''+dropdown_pin+'';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
  };
   ...
   //颜色刷屏
  Blockly.Arduino.qdp_esp32_zkpdisplay_clscolor = function() {
    var num = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  ...
  //表情刷屏
  Blockly.Arduino.qdp_esp32_zkpdisplay_pic = function() {
    var dropdown_pin = this.getFieldValue('pin2');
   ...
   //页面跳转
  Blockly.Arduino.qdp_esp32_zkpdisplay_page = function() {
    var dropdown_pin = this.getFieldValue('pin2');
  ...
  //画圆
  Blockly.Arduino.qdp_esp32_zkpdisplay_drawinground = function() {
    var dropdown_pin = this.getFieldValue('pin2');
    var num1 = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    var num2 = Blockly.Arduino.valueToCode(this, 'num2',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    var num3 = Blockly.Arduino.valueToCode(this, 'num3',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  ...
  //画线矩形区域填充
  Blockly.Arduino.qdp_esp32_zkpdisplay_function1 = function() {
    var dropdown_pin = this.getFieldValue('pin2');
    var num1 = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    var num2 = Blockly.Arduino.valueToCode(this, 'num2',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    var num3 = Blockly.Arduino.valueToCode(this, 'num3',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  ...
  //文字信息
  Blockly.Arduino.qdp_esp32_zkpdisplay_TEXT = function() {
    var num1 = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    var num2 = Blockly.Arduino.valueToCode(this, 'num2',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    var num3 = Blockly.Arduino.valueToCode(this, 'num3',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    var num4 = Blockly.Arduino.valueToCode(this, 'num4',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  ...
  //文字信息
  Blockly.Arduino.qdp_esp32_zkpdisplay_TEXT_CN = function() {
    var number = Math.ceil(Math.random() * 100000);  
    var num1 = Blockly.Arduino.valueToCode(this, 'num1',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    var num2 = Blockly.Arduino.valueToCode(this, 'num2',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    var num3 = Blockly.Arduino.valueToCode(this, 'num3',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
  ...
  //自定义指令
  Blockly.Arduino.qdp_esp32_zkpdisplay_order = function() {
    var text = Blockly.Arduino.valueToCode(this, 'text',Blockly.Arduino.ORDER_ATOMIC) ||'0' ;
    Blockly.Arduino.setups_['setup_qdprobot_serial']= 'Serial.begin(9600);';
  ...
  //Preferences储存打开命名空间
  Blockly.Arduino.QDP_Preferences_Open = function() {
    var Name = Blockly.Arduino.valueToCode(this, 'Name', Blockly.Arduino.ORDER_ATOMIC);
    var model = this.getFieldValue('model'); 
    Blockly.Arduino.definitions_['include_Preferences'] = '#include <Preferences.h>';
    Blockly.Arduino.definitions_['var_declare_Preferences'] = 'Preferences prefs;';
    var code = 'prefs.begin('+Name+','+model+');\n';
    return code;
  };

  //Preferences储存读取
  Blockly.Arduino.QDP_Preferences_Read = function() {
    ...
    Blockly.Arduino.definitions_['var_declare_Preferences'] = 'Preferences prefs;';
     if(TYPE=='Bytes')
    {
      var code = 'prefs.get'+TYPE+'(String('+KEY+').c_str(),prefs.getBytesLength(String('+KEY+').c_str()))';
    }else
    {
      var code = 'prefs.get'+TYPE+'(String('+KEY+').c_str())';
    }   
    return [code, Blockly.Arduino.ORDER_ATOMIC];
  };

  //Preferences储存写入
  Blockly.Arduino.QDP_Preferences_Write = function() {
    var KEY = Blockly.Arduino.valueToCode(this, 'KEY', Blockly.Arduino.ORDER_ATOMIC);
    var TYPE = this.getFieldValue('TYPE'); 
    ...
    if(TYPE=='Bytes')
    {
      var code = 'prefs.put'+TYPE+'(String('+KEY+').c_str(),'+Value+',sizeof('+Value+'));\n';
    }else
    {
      var code = 'prefs.put'+TYPE+'(String('+KEY+').c_str(),'+Value+');\n';
    } 
    return code;
  };

  //Preferences关闭文件
  Blockly.Arduino.QDP_Preferences_Close = function() {
    Blockly.Arduino.definitions_['include_Preferences'] = '#include <Preferences.h>';
    Blockly.Arduino.definitions_['var_declare_Preferences'] = 'Preferences prefs;';
    var code = 'prefs.end();\n';
    return code;
  ...
  //ESP一键配网
  Blockly.Arduino.QDP_esp32_smartConfig_ = function() {
  ...
  //esp配置访问点
  Blockly.Arduino.QDP_esp32_config_access_point = function() {
    ...
    Blockly.Arduino.setups_['config_access_point_setup'] = 'MonEsp.connect_AP('+ssid+','+pwd+');';
    var code = "";
   ...
   //esp连接WIFI
  Blockly.Arduino.QDP_esp32_config_station = function() {
    var ssid = Blockly.Arduino.valueToCode(this, 'ssid', Blockly.Arduino.ORDER_ATOMIC);
    var pwd = Blockly.Arduino.valueToCode(this, 'pwd', Blockly.Arduino.ORDER_ATOMIC);
    Blockly.Arduino.definitions_['include_QDP_ESP_WIFI'] = '#include <QDP_ESP_WIFI.h>';
    Blockly.Arduino.definitions_['var_declare_QDP_ESP_WIFI'] = 'QDP_ESP_WIFI MonEsp;';
  ...
  //配置多站点模式
  Blockly.Arduino.QDP_esp32_config_multi_station = function() {
    var ssid = Blockly.Arduino.valueToCode(this, 'ssid', Blockly.Arduino.ORDER_ATOMIC);
    var pwd = Blockly.Arduino.valueToCode(this, 'pwd', Blockly.Arduino.ORDER_ATOMIC);
    Blockly.Arduino.definitions_['include_WiFi'] = '#include <WiFi.h>';
    Blockly.Arduino.definitions_['include_WiFiMulti'] = '#include <WiFiMulti.h>';
    Blockly.Arduino.definitions_['var_declare_WiFiMulti'] = 'WiFiMulti wifiMulti;';
    Blockly.Arduino.setups_['config_access_point_setup'+ssid] = 'wifiMulti.addAP('+ssid+','+pwd+');';
    var code = "";
   ...
   //wifi多站点连接状态
  Blockly.Arduino.QDP_multi_status = function() {
    var code = 'wifiMulti.run() != WL_CONNECTED';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
  };

  //配置域名
  Blockly.Arduino.QDP_esp32_config_domaine_name_mDNS = function() {
  ...
  Blockly.Arduino.qdp_ESP32_set_mac_address = function () {
    ...
    var code = "";    
    Blockly.Arduino.definitions_['include_WiFi'] ='#include <WiFi.h>';
    Blockly.Arduino.definitions_['include_esp_wifi'] ='#include <esp_wifi.h>';
  ...
  //esp_now发送数据
  Blockly.Arduino.QDP32_esp_now_send = function () {
...
"新港":"101340904"
  ...
  Blockly.Arduino.qdp_PS2_init = function() {
    ...
    var pressures=this.getFieldValue('pressures');
    ...
    Blockly.Arduino.setups_['setup_output_1'] = 'int error = -1;\nwhile (error != 0) {\ndelay(1000);\nerror = ps2x.config_gamepad('+PS2_CLK+','+PS2_CMD+','+PS2_SEL+','+PS2_DAT+', '+pressures+', '+rumble+');\nSerial.println("#try config ");\n}\nSerial.println("config succeeded!");\ndelay(100);';  
    return "";
  };

  Blockly.Arduino.qdp_PS2_update = function() {
   var motor1 = Blockly.Arduino.valueToCode(this, 'motor1', Blockly.Arduino.ORDER_ATOMIC);
   var motor2 = Blockly.Arduino.valueToCode(this, 'motor2', Blockly.Arduino.ORDER_ATOMIC);
   var motor = "";
   if(motor1&& motor2)
    motor = motor1+','+motor2;
   var code = 'ps2x.read_gamepad('+motor+');\ndelay(30);\n';
   return code;
  };

  Blockly.Arduino.qdp_PS2_Button = function() {
  ...
  Blockly.Arduino.qdp_PS2_stk = function() {
  ...
  Blockly.Arduino.utf8togbk = function() {
    ...
    var code= "text_code.transform("+input_data+")";
    return [code, Blockly.Arduino.ORDER_ATOMIC];
  };
