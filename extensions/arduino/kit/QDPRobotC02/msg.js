...
function addMsg (Blockly) {
    Object.assign(Blockly.ScratchMsgs.locales.en, {
        ...
        QH_esp32_display_samll_flash_pic:'Picture show Port %1 H/V %2 Mode %3 Picture %4',
        ...
        qdp_esp32_BT_print_string:'Bluetooth send string %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales['zh-cn'], {
        ...
        QDP_inout_esp32_touchRead:'触摸 端口 # %1 的值',
        QDP_inout_esp32_touchEvents:'触摸事件 端口 # %1 模式 %2 ',
        ...
        qdp_esp32_ledlight3:'LED 端口 %1 值(0~255) %2',
        qdp_esp32_relay:'继电器 端口 %1 状态 %2',
        qdp_esp32_read_relay:'读取 继电器 端口 %1 ',
        ...
        qdp_esp32_BT_print_string:'蓝牙发送字符串变量 %1',
    ...
    Object.assign(Blockly.ScratchMsgs.locales["zh-tw"], {
        ...
        DHT_INIT: '初始化 dht %1 端口 %2 型號 %3',
        QDP_blink_32:'學習二維碼',
        QDP_esp32_display_samll_init:'彩屏初始化 %1 端口 %2 串列傳輸速率 %3',
        QDP_esp32_display_samll_refresh_display:'%1 彩屏刷新顯示 %2',
        QDP_esp32_display_samll_HV:'彩屏方向 端口 %1 %2',
        ...
        QDP_esp32_display_samll_BL:'彩屏亮度 端口 %1 亮度0~255 %2',
        QDP_esp32_display_samll_clr:'顏色 端口 %1 %2 顏色 0~63 %3',
        QDP_display_samll_clr1:'刷屏',
        QDP_display_samll_clr2:'背景',
        QH_esp32_display_samll_flash_pic:'圖片顯示 端口 %1 橫/豎 %2 模式 %3 圖片 %4',
        QH_display_samll_HV10:'橫屏',
        QH_display_samll_HV11:'豎屏',
        QH_display_small_mode0:'正常',
        QH_display_samll_mode1:'透明',
        QDP_esp32_display_samll_pic:'圖片顯示 端口 %1 %2 地址 %3 起點 X %4 Y %5 寬 %6 高 %7',
        QDP_display_samll_pic0:'正常',
        QDP_display_samll_pic1:'透明',
        QDP_esp32_customize_display_define_bitmap_data:'彩屏 圖像名稱 %1 圖像數據 %2',
        QDP_esp32_customize_display:'彩屏自定義顯示 端口 %1 圖像名稱 %2 起點 X %3 Y %4 寬 %5 高 %6 顏色 0~63 %7',
        QDP_esp32_display_samll_PS:'畫點 端口 %1 X %2 Y %3 顏色 0~63 %4',
        QDP_esp32_display_samll_PL:'畫線/框 端口 %1 %2 起點 X %3 Y %4 終點 X %5 Y %6 顏色 0~63 %7',
        QDP_display_samll_pl1:'畫線',
        QDP_display_samll_pl2:'空心框',
        QDP_display_samll_pl3:'實心框',
        QDP_esp32_display_samll_CIR:'畫圓 端口 %1 %2 圓心 X %3 Y %4 半徑 %5 顏色 0~63 %6',
        MIXLY_QDP_displayhollowround:'空心',
        MIXLY_QDP_displaysolidround:'實心',
        QDP_esp32_display_samll_DC:'文本 端口 %1 字型大小 %2 顏色 0~63 %3 起點 X %4 Y %5 內容 %6',
        QDP_esp32_display_samll_SBCDC:'帶底色文本 端口 %1 字型大小 %2 底色 %3 顏色 0~63 %4 起點 X %5 Y %6 內容 %7',
        QDP_esp32_display_samll_order:'自定義指令 端口 %1 %2',
        QDP_esp32_display_samll_btl:'彩屏串列傳輸速率 端口 %1 %2',
        QDP_inout_esp32_touchRead:'觸摸 端口 # %1 的值',
        QDP_inout_esp32_touchEvents:'觸摸事件 端口 # %1 模式 %2 ',
        MIXLY_ESP32_TOUCH_Events_changed:'改變',
        MIXLY_ESP32_TOUCH_Events_touching:'按住',
        MIXLY_ESP32_TOUCH_Events_touched:'單按',
        qdp_esp32_buttonl:'按鈕 端口 %1',
        qdp_esp32_buttonx:'左或右 按鈕 端口 %1',
        qdp_esp32_buttonfuction1:'啟用多功能按鈕 端口 %1',
        qdp_esp32_button1:'多功能按鈕 端口 %1 觸發方式 %2',
        ...
        QH_Temperature:'溫度',
        QH_Humidity:'濕度',
        qdp_esp32_yscgq:'初始化顏色識別 延時 %1 MS 光敏增益 %2 倍 值 %3 I2C地址0x29',
        QH_noPrint:'不列印',
        QH_Print:'列印',
        qdp_yscgq2:'獲取顏色值 %1',
        qdp_yscgq3:'顏色 如果 %1 = %2 偏差 ± %3',
        QDP_ESP32_MPU6050_update:'啟用陀螺儀(IIC)刷新數據',
        QDP_ESP32_MPU6050_GETDATA:'讀取陀螺儀的值 %1',
        QH_Accel_X:"X軸加速度", 
        QH_Accel_Y:"Y軸加速度", 
        QH_Accel_Z:"Z軸加速度",
        QH_Gyro_X:"X軸角度",
        ...
        QH_Gyro_Z:"Z軸角度",
        QH_readTempC:"溫度",
        QDP_ESP32_hallRead:'EPS32片內霍爾值',
        qdp_esp32_ledlight:'LED 端口 %1 狀態 %2',
        qdp_esp32_read_ledlight:'讀取 LED 端口 %1',
        qdp_esp32_ledlight3:'LED 端口 %1 值(0~255) %2',
        qdp_esp32_relay:'繼電器 端口 %1 狀態 %2',
        qdp_esp32_read_relay:'讀取 繼電器 端口 %1 ',
        rgb_esp32_led:'RGB LED 端口 %1 總數 %2  燈號 %3 R %4 G %5 B %6',
        rgb_esp32_led2:'RGB LED 端口 %1 總數 %2  燈號 %3 顏色 %4',
        qdp_esp32_buzzer3:'蜂鳴器 端口 %1 頻率 %2 持續時間 %3 通道 %4',
        qdp_esp32_buzzer_music:'蜂鳴器 端口 %1 演奏音樂 %2 通道 %3',
        qdp_esp32_motor:'直流電機 端口 %1 連接 %2 速度(-255~255) %3',
        qdp_esp32_servomotor360:'舵機360° 端口 %1 方向 %2 速度(0~10) %3',
        QH_CW:'正轉',
        QH_CCW:'反轉',
        qdp_esp32_servomotor2:'舵機180° 端口 %1 角度(0~180) %2 ',
        qdp_esp32_servomotorread:'舵機讀取角度 端口 %1',
        qdp_esp32_servomotorPWM_set180:'舵機板180° 板號 %1 [參數設置] PWM下限值 範圍(1-4095) %2 PWM 上限值 範圍(2-4096) %3',
        qdp_esp32_servomotorPWM:'舵機板180° 板號 %1 舵機號(0~15) %2 角度 %3 ',
        qdp_esp32_servomotorPWM_set360:'舵機板360° 板號 %1 [參數設置] PWM停止值 %2 PWM 正轉下限值  %3 PWM 正轉上限值  %4 PWM 反轉下限值  %5 PWM 反轉上限值  %6 ',
        qdp_esp32_servomotorPWM360:'舵機板360° 板號 %1 方向 %2 舵機號(0-15)  %3 速度(0-10) %4',
        QDP32_ASR_SendData:'發送到齊護語音識別 端口 %1 指令 %2',
        QDP32_ASR_ReceiveData:'齊護語音識別 開啟 端口 %1',
        QDP32_ASR_CompareData:'齊護語音識別到 端口 %1 指令 %2',
        speech_recognition_initialization:'AI語音識別初始化 端口 %1 授權碼 %2',
        speech_recognition:'AI語音識別返回結果 目標語言 %1',
        AI_SPEECH_RECOGNITION3:'普通話',
        AI_SPEECH_RECOGNITION4:'普通話/簡單英語',
        AI_SPEECH_RECOGNITION5:'英語',
        AI_SPEECH_RECOGNITION6:'粵語',
        identification_switch:'AI 語音識別錄音停止',
        qdp_esp32_QF_hc_init:'語音合成 初始化 %1 端口 %2',
        qdp_esp32_QF_hc:'語音合成 發音人 %1 中斷 %2 音量(0-11) %3 語速(0-11) %4 語調(0-11) %5 內容 %6',
        QH_Donotinterrupt:'不中斷',
        QH_Interruptible:'中斷',
        qdp_esp32_QF_sound:'播放提示音 類型 %1 編號(01~25) %2',
        qdp_esp32_QF_stophc:'停止合成',
        qdp_esp32_QF_startstopsb:'開啟語音識別 播報識別 %1 ',
        QH_Sayresult:'播報識別結果',
        QH_NoSayresult:'不播報識別結果',
        qdp_esp32_QF_sbjg:'識別結果 識別到 %1',
        ...
        qdp_esp32_BT_START:'啟用藍牙 名稱 %1 %2',
        qdp_esp32_BT_button:'藍牙按鈕 %1',
        qdp_esp32_BT_variable:'藍牙變數 %1',
        qdp_esp32_BT_print:'藍牙發送變數 變數1 %1 變數2 %2 變數3 %3 變數4 %4 變數5 %5',
        qdp_esp32_BT_print_string:'藍牙發送字串變數 %1',
        qdp_esp32_BT_MASTER_CONNECT:'藍牙Master連接 從機 %1  %2 %3',
        QDPROBOT_NAME:'名稱',
        qdp_esp32_BT_MASTER_AVAILABLE:'藍牙Master是否有數據可讀',
        qdp_esp32_BT_MASTER_CONNECTED:'藍牙Master是否連接? 超時 %1',
        qdp_esp32_BT_MASTER_CONNECT_CONTROL:'藍牙Master連接控制 %1',
        QDPROBOT_CONNECT:'連接',
        QDPROBOT_DISCONNECT:'斷開',
        qdp_esp32_BT_MASTER_READ:'藍牙Master讀取數據',
        qdp_esp32_BT_MASTER_WRITE:'藍牙Master寫數據 %1 %2',
        qdp_esp32_serial_jieshouzhi:'串口接收數據比較 端口 %1 如果數據= %2',
        qdp_esp32_serial_fasong:'串口發送 端口 %1 模式 %2 內容 %3',
        QH_SERIAL_WRITE:'原始輸出',
        QH_SERIAL_PRINT:'列印',
        QH_SERIAL_PRINTLN:'列印(自動換行)',
        qdp_esp32_serial_jieshou:'串口接收 端口 %1 返回字串',
        qdp_esp32_serial_suju:'串口有數據可讀 端口 %1',
        esp32_BleKeyboard_init:'藍牙鍵盤初始化 設備名稱 %1 設備廠商 %2',
        esp32_BleKeyboard_isConnected:'藍牙鍵盤啟用 已連接?',
        esp32_BleKeyboard_KeyValue:'鍵值 %1',
        esp32_BleKeyboard_write_press:'藍牙鍵盤 %1 鍵值 %2',
        esp32_BleKeyboard_print :'列印',
        esp32_BleKeyboard_write :'按下',
        esp32_BleKeyboard_press :'按住',
        esp32_BleKeyboard_release :'釋放',
        esp32_BleKeyboard_releaseAll :'釋放所有',
        esp32_Mp3_init:'Mp3 初始化 %1 端口 %2',
        qdp_esp32_MP3_bofangx:'播放指定 音量(0-30) %1 曲目 %2',
        qdp_esp32_MP3_yingliang:'音量調節 音量(0-30) %1',
        qdp_esp32_MP3_loopplay:'迴圈播放 音量(0-30) %1 曲目 %2',
        qdp_esp32_MP3_startpause:'播放/暫停 模式 %1',
        QH_START:'播放',
        QH_PAUSE:'暫停',
        qdp_esp32_MP3_previous_next:'上一首/下一首 模式 %1',
        QH_PREVIOUS:'上一首',
        ...
        QH_play13:'13老虎',
        QH_play14:'14雞',
        qdp_ESP32_define_mp3_directory:'定義MP3 SD卡檔目錄 %1 ',
        qdp_ESP32_mp3_designated_play:'模式 %1 音量(0-30) %2 曲目 %3',
        QH_BOFANGX:'播放指定',
        QH_LOOPPLAY:'迴圈播放',
        qdp_esp32_display:'數碼管 端口 %1 %2 顯示 %3',
        qdp_esp32_display_no:'整數',
        qdp_esp32_display_no2:'字母',
        qdp_esp32_display_clear:'數碼管 清屏 端口 %1',
        qdp_esp32_displayoff:'數碼管 關閉 端口 %1',
        esp32_oled_init:'OLED 初始化 端口 # %1',
        esp32_oled_page:'%1 OLED 刷新頁面',
        esp32_oled_showBitmap:'OLED 顯示圖像 起點 X %1 Y %2 寬度 %3 高度 %4 圖像名稱 %5',
        esp32_oled_set_EN_Font:'OLED 設置英文字體 %1 字型大小 %2 字形 %3',
        esp32_oled_set_CN_Font:'OLED 設置中文字體 %1 字型大小 %2',
        ...
        esp32_oled_print:'OLED 顯示文本 起點 X %1 Y %2 內容 %3',
        tool_modulus_show:'圖像名稱 %1 [%2] 保存到 flash %3 %4',
        tool_modulus:'點陣格式 %1 取模方式 %2 取模走向 %3 字體 %4 字型大小 %5 px 寬 %6 px 高 %7 px 內容 %8',
        esp32_oled_clear:'OLED  清屏 ',
        esp32_u8g2_setContrast:'OLED  背光亮度 %1',
        esp32_oled_face:'OLED 顯示圖像 起點 X %1 Y %2 內置圖示 %3',
        esp32_oled_drawPixel:'OLED 畫點 起點 X %1 Y %2 ',
        esp32_oled_drawLine:'OLED 畫線 起點 X %1 Y %2 終點 X %3 Y %4',
        esp32_oled_draw_Str_Line:'OLED 畫直線 起點 X %1 Y %2 長度 X %3 模式 %4',
        QH_OLED_HOR:'水準',
        QH_OLED_VER:'垂直',
        esp32_oled_drawFrame:'OLED 畫矩形 模式 %1 起點 X %2 Y %3 寬  %4 高 %5',
        esp32_oled_drawRFrame:'OLED 畫圓角矩形 模式 %1 起點 X %2 Y %3 寬  %4 高 %5 半徑 %6',
        esp32_oled_drawCircle:'OLED 畫圓 模式 %1 圓心 X %2 Y %3 半徑  %4 類型 %5',
        QH_OLED_WHOLE_CICILE:'整圓',
        QH_OLED_UP_R:'右上',
        QH_OLED_UP_L:'左上',
        QH_OLED_LOW_R:'右下',
        QH_OLED_LOW_L:'左下',
        esp32_oled_drawEllipse:'OLED 畫橢圓 模式 %1 圓心 X %2 Y %3 半徑 X %4 Y %5 類型 %6',
        QH_OLED_HOLLOW:'空心',
        QH_OLED_SOLID:'實心',
        esp32_oled_drawTriangle:'OLED 畫三角形 A點 X %1 Y %2 B點 X %3 Y %4 C點 X %5 Y %6',
        group_lcd_init2:'初始化 LCD %1 名稱 %2 設備地址 %3 SCL %4 SDA %5',
        ...
        qdp_esp32_ZKDisplay_init:'掌控屏 初始化 端口 %1',
        qdp_esp32_display_START:' %1 啟用接收屏數據 ',
        qdp_esp32_display_button:'屏按鈕 = %1',
        ...
        QDP_Preferences_Open:'掉電存儲 打開檔 %1 %2',
        QDP_Preferences_Read:'掉電存儲 讀取 鍵名 %1 數據類型 %2 ',
        QDP_Preferences_Write:'掉電存儲 寫入 鍵名 %1 數據類型 %2 值 %3',
        QDP_Preferences_Close:'掉電存儲 關閉檔',
        QDP_Preferences_R_W:'讀/寫',
        QDP_Preferences_R:'只讀',
        QDP_esp32_smartConfig_:'Web一鍵配網',
        QDP_esp32_config_access_point:'ESP 開啟WIFI熱點 名稱 %1 密碼 :%2',
        QDP_esp32_config_station:'ESP 連接WIFI 名稱 %1 密碼 :%2',
        QDP_WiFi_status:'WIFI連接狀態',
        QDP_esp32_wifi_IP:'IP 地址',
        QDP32_mac_address:'MAC 地址',
        QDP_esp32_config_multi_station:'ESP 配置多站點 WIFI 名稱 %1 密碼 :%2',
        QDP_multi_status:'WIFI多站點連接狀態',
        QDP_esp32_config_domaine_name_mDNS:'ESP 配置功能變數名稱http:// %1 .local',
        qdp_ESP32_set_mac_address:'設置MAC地址 %1',
        QDP32_esp_now_send:'%1 ESPNOW發送 MAC %2 數據 %3 %4 發送成功 %5 發送失敗 %6',
        QDP32_esp_now_receive:'%1 ESPNOW接收 %2  %3',
        ...
        controls_runnig_core: '多任務調度器 %1 setup',
        control_core_delay: '多任務調度器延時 %1 ms',
        QH_EQU:'等於(==)',
        QH_NEQ:'不等於(!=)',
        QH_GTR:'大於(>)',
        QH_LSS:'小於(<)',
        ...
        MIXLY_MINUTE:'分',
        MIXLY_SECOND:'秒',
        qdp_PS2_init:'初始化PS2 DAT %1 CMD %2 SEL %3 CLK %4 振動回饋 %5 按壓回饋 %6',
        qdp_PS2_update:'PS2手柄刷新數據 振動電機1(true/false) %1 振動電機2(0~255) %2',
        qdp_PS2_Button:'PS2 按鍵 %1 狀態 %2',
        qdp_PS2_stk:'PS2搖杆 %1',
        MIXLY_BUTTON_HOLD:'按住',
        MIXLY_BUTTON_PRESSED:'按下',
        MIXLY_BUTTON_RELEASED:'鬆開',
        MIXLY_CHANGE:'改變',
        PS2_RX:'右側X值',
        PS2_RY:'右側Y值',
        PS2_LX:'左側X值',
