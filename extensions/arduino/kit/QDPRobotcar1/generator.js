...
function addGenerator(Blockly) {
    ...
    //超声波
    Blockly.Arduino.QH_UltraSonicDistanceSensor_Car01 = function() {
        var dropdown_pin = '3';
    ...
    //巡线
    Blockly.Arduino.QH_Line_follower_Car01 = function() {
        var PIN = '1';
    ...
    //RBGLED
    Blockly.Arduino.QH_rgb_led_Car01 = function() {
    ...
    //RBGLED2
    Blockly.Arduino.QH_rgb_led2_Car01 = function() {
        Blockly.Arduino.definitions_['include_display'] = '#include "QDPRGBLED.h"';
        var pin1 = '2';
        var NUM = Blockly.Arduino.valueToCode(this, 'num1', Blockly.Arduino.ORDER_ATOMIC) || '0';
    ...
    //蜂鸣器
    Blockly.Arduino.QH_buzzer_Car01 = function() {
        var dropdown_pin = '6';
        var dropdown_pin2 = this.getFieldValue('PIN2');
    ...
    //蜂鸣器音乐
    Blockly.Arduino.QH_buzzer_music_Car01 = function() {
        var dropdown_pin = '6';
        var dropdown_pin2 = this.getFieldValue('PIN2');
        Blockly.Arduino.definitions_['define_qdport'] = '#include <QDPport.h>';
        Blockly.Arduino.definitions_['define_qdportqdpbuzzer'] = '#include "QDPBuzzer.h"';
    ...
    //直流电机
    Blockly.Arduino.QH_motor_Car01 = function() {
    ...
    //舵机
    Blockly.Arduino.QH_servomotor180_Car01 = function() {
        var dropdown_pin = this.getFieldValue('pin');
    ...
    //舵机角度
    Blockly.Arduino.QH_servomotorread_Car01 = function() {
        var dropdown_pin = this.getFieldValue('pin');
        Blockly.Arduino.definitions_['define_qdport'] = '#include <QDPport.h>';
        Blockly.Arduino.definitions_['define_qdprobotread'] = '#include <VarSpeedServo.h>';
        Blockly.Arduino.definitions_['var_declare_qdprobot_motor31' + dropdown_pin] = 'VarSpeedServo QDPservo_' + dropdown_pin + ';\n';
    ...
    //红外遥控器
    Blockly.Arduino.QH_ir_re2_Car01 = function() {
        var dropdown_pin = '4';
    ...
    //串口接收的数据等于
    Blockly.Arduino.QH_serial_jieshouzhi_Car01 = function() {
        var num = Blockly.Arduino.valueToCode(this, 'text', Blockly.Arduino.ORDER_ATOMIC) || '0';
        Blockly.Arduino.definitions_['define_qdport'] = '#include <QDPport.h>';      
        Blockly.Arduino.definitions_['J1_return_SoftwareSerial'] = 'bool portReceived_Serial(String inputStr) {\n' + 'static String recStr = "";\n' + 'if (Serial.available() > 0) {\n' + '  recStr = Serial.readString();\n' + '}\n' + 'if (String(recStr).equals(String(inputStr))) {\n' + '  recStr = "";\n' + '  return true;\n' + '}\n' + 'return false;\n' + '}\n';
    ...
    //串口发送
    Blockly.Arduino.QH_serial_fasong_Car01 = function() {
    ...
    //串口接收
    Blockly.Arduino.QH_serial_jieshou_Car01 = function() {
        Blockly.Arduino.definitions_['define_qdport'] = '#include <QDPport.h>';
        Blockly.Arduino.setups_['setup_qdprobot_serial'] = 'Serial.begin(115200);';
    ...
    //串口有数据可读
    Blockly.Arduino.QH_serial_suju_Car01 = function() {
        Blockly.Arduino.definitions_['define_qdport'] = '#include <QDPport.h>';
        Blockly.Arduino.setups_['setup_qdprobot_serial'] = 'Serial.begin(115200);';
