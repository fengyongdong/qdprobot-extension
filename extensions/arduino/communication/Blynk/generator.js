...
//物联网-服务器信息
Blockly.Arduino.QDP_esp32_blynk_server = function() {
  ...
  var auth_key = Blockly.Arduino.valueToCode(this, 'qdp_auth_key', Blockly.Arduino.ORDER_ATOMIC);
  var server_add = Blockly.Arduino.valueToCode(this, 'qdp_server_add', Blockly.Arduino.ORDER_ATOMIC);
  ...
  Blockly.Arduino.setups_['qdp_setup_Blynk.begin'] = 'Blynk.begin(auth,ssid,pass,IPAddress('+server_add+'),8080);';  
  var code="Blynk.run();\n";
  return code;
};
...
//当设备连接到blynk云服
Blockly.Arduino.QDP_BLYNK_CONNECTED = function() {
...
//当设备连接上APP
Blockly.Arduino.QDP_BLYNK_APP_CONNECTED = function() {
  var branch = Blockly.Arduino.statementToCode(this, 'DO');
    branch = branch.replace(/(^\s*)|(\s*$)/g, "");//去除两端空格
...
//当设备断开APP
Blockly.Arduino.QDP_BLYNK_APP_DISCONNECTED = function() {
  var branch = Blockly.Arduino.statementToCode(this, 'DO');
    branch = branch.replace(/(^\s*)|(\s*$)/g, "");//去除两端空格
...
//硬件连接服务器状态
Blockly.Arduino.QDP_blynk_iot_CONNECTED = function() {
...
//物联网-同步管脚数据
Blockly.Arduino.QDP_blynk_iot_syncVirtual = function () {
  var Vpin = this.getFieldValue('Vpin');
  if(Vpin=='ALL')
...
//物联网-发送数据到app
Blockly.Arduino.QDP_blynk_iot_push_data = function() {
  var Vpin = this.getFieldValue('Vpin');
...
//blynk 定时器
Blockly.Arduino.QDP_Blynk_iot_timer = function () {
...
//LED组件颜色&开关
Blockly.Arduino.QDP_blynk_iot_WidgetLED_COLOR=function(){
  var Vpin = this.getFieldValue('Vpin');
...
//LED组件颜色&亮度
Blockly.Arduino.QDP_blynk_iot_WidgetLED_VALUE=function(){
  var Vpin = this.getFieldValue('Vpin');
  var colour_rgb_led_color = Blockly.Arduino.valueToCode(this, 'RGB_LED_COLOR', Blockly.Arduino.ORDER_ATOMIC);
...
//发送邮件
Blockly.Arduino.QDP_blynk_email = function() {
...
//发送通知（国内用不了，先关了）
/*Blockly.Arduino.QDP_blynk_notify = function() {
  var content = Blockly.Arduino.valueToCode(this, 'content', Blockly.Arduino.ORDER_ATOMIC);
  var code=' Blynk.notify('+content+');\n';
  return code;
};

Blockly.Arduino.QDP_blynk_terminal_clear = function () {
  var code = 'terminal.clear();\n';
  return code;
};
*/
//从终端获取字符串
Blockly.Arduino.QDP_blynk_iot_terminal_get = function () {
  var Vpin = this.getFieldValue('Vpin');
...
//物联网-终端组件显示文本
Blockly.Arduino.QDP_blynk_terminal = function() {
  var Vpin = this.getFieldValue('Vpin');
...
//Blynk LCD显示
Blockly.Arduino.QDP_blynk_lcd = function () {
  var Vpin = this.getFieldValue('Vpin');
...
//Blynk LCD清屏
Blockly.Arduino.QDP_blynk_lcd_clear = function () {
  var code = 'lcd.clear();\n';
  return code;
};

//Blynk Table小部件添加数据
Blockly.Arduino.QDP_blynk_table = function () {
...
//Blynk Table小部件数据操作
Blockly.Arduino.QDP_blynk_table_highlight = function () {
  var id = Blockly.Arduino.valueToCode(this, 'id', Blockly.Arduino.ORDER_ATOMIC);
  var xnyj = this.getFieldValue('Vpin');
  var mode = this.getFieldValue('mode');
...
//Blynk Table小部件数据清除
Blockly.Arduino.QDP_blynk_table_cleardata = function () {
  var xnyj = this.getFieldValue('Vpin');
...
//时间输入
Blockly.Arduino.QDP_blynk_time_input_1 = function () {
  var Vpin = this.getFieldValue('Vpin');
  var branch = Blockly.Arduino.statementToCode(this, 'DO');
    branch = branch.replace(/(^\s*)|(\s*$)/g, "");//去除两端空格
...
//视频流
Blockly.Arduino.QDP_blynk_videourl = function() {
  var Vpin = this.getFieldValue('Vpin');
...
//桥接授权码
Blockly.Arduino.QDP_blynk_bridge_auth = function() {
  var Vpin = this.getFieldValue('Vpin');
...
//桥接数字输出
Blockly.Arduino.QDP_blynk_bridge_digitalWrite = function() {
...
//桥接模拟输出
Blockly.Arduino.QDP_blynk_bridge_AnaloglWrite = function() {
  var dropdown_pin = Blockly.Arduino.valueToCode(this, 'PIN', Blockly.Arduino.ORDER_ATOMIC);
  var num = this.getFieldValue('num');
  var value_num = Blockly.Arduino.valueToCode(this, 'NUM', Blockly.Arduino.ORDER_ATOMIC);
...
//桥接虚拟管脚
Blockly.Arduino.QDP_blynk_bridge_VPin = function() {
  var Vpin = this.getFieldValue('Vpin');
  var num = this.getFieldValue('num');
  var value_num = Blockly.Arduino.valueToCode(this, 'NUM', Blockly.Arduino.ORDER_ATOMIC);
...
//RTC获取时间
Blockly.Arduino.QDP_blynk_WidgetRTC_get_time = function () {
...
//播放音乐组件
Blockly.Arduino.QDP_blynk_iot_playmusic = function () {
  var Vpin = this.getFieldValue('Vpin');
...
//光线传感器
Blockly.Arduino.QDP_blynk_light = function () {
  var Vpin = this.getFieldValue('Vpin');
  var branch = Blockly.Arduino.statementToCode(this, 'DO');
    branch = branch.replace(/(^\s*)|(\s*$)/g, "");//去除两端空格
    var code = 'BLYNK_WRITE' + '(' +Vpin+'){\nint lx = param.asInt();\n'+branch+'\n}';
...
//重力传感器
Blockly.Arduino.QDP_blynk_gravity = function () {
  var Vpin = this.getFieldValue('Vpin');
  var branch = Blockly.Arduino.statementToCode(this, 'DO');
    branch = branch.replace(/(^\s*)|(\s*$)/g, "");//去除两端空格
