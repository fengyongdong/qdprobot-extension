const QDPRobot = formatMessage => ({
    ...
    msg: `msg.js`,                //扩展的多语言支持
    location: 'local',            // or 'remote'只有 local / remote 两个选项，用来标识扩展是部署在云端还是本地，在目前的版本中，直接默认为local 即可，此参数可能在之后将会弃用。
    tags: ['actuator', 'sensor', 'display', 'communication', 'other'],             //标识此插件的类目。可选选项有：actuator, sensor, display, communication, other。
